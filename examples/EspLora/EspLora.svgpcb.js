...
board.setNetlist([
  ...
  {name: "Lledr.res.a", pads: [["LD2", "1"], ["LR4", "1"]]},
  {name: "Lledg.signal", pads: [["LU2", "35"], ["LD3", "2"]]},
  {name: "Lledg.res.a", pads: [["LD3", "1"], ["LR5", "1"]]},
  {name: "Lledb.signal", pads: [["LU2", "39"], ["LD4", "2"]]},
  {name: "Lledb.res.a", pads: [["LD4", "1"], ["LR6", "1"]]},
  ...
  {name: "Llora.xtal.crystal.xtal_in", pads: [["LU4", "3"], ["LX1", "1"]]},
  {name: "Llora.xtal.crystal.xtal_out", pads: [["LU4", "4"], ["LX1", "3"]]},
  {name: "Llora.dcc_l.a", pads: [["LU4", "9"], ["LL1", "1"]]},
  {name: "Llora.rf_sw.ctrl", pads: [["LU4", "12"], ["LR8", "1"]]},
  {name: "Llora.rf_sw.vdd_res.b", pads: [["LU5", "6"], ["LR7", "2"]]},
  {name: "Llora.rf_sw.ctrl_res.b", pads: [["LU5", "4"], ["LR8", "2"]]},
  {name: "Llora.tx_dcblock.pos", pads: [["LU5", "1"], ["LC11", "1"]]},
  {name: "Llora.rfc_dcblock.pos", pads: [["LC12", "1"], ["LC17", "1"], ["LL6", "1"]]},
  {name: "Llora.rfc_dcblock.neg", pads: [["LU5", "5"], ["LC12", "2"]]},
  {name: "Llora.tx_pi.output", pads: [["LC11", "2"], ["LC14", "1"], ["LL4", "2"]]},
  {name: "Llora.balun.input", pads: [["LU5", "3"], ["LC15", "1"]]},
  {name: "Llora.balun.rfi_n", pads: [["LU4", "22"], ["LL5", "1"], ["LC15", "2"]]},
  {name: "Llora.balun.rfi_p", pads: [["LU4", "21"], ["LL5", "2"], ["LC16", "1"]]},
  ...
  {name: "Loled.c1_cap.pos", pads: [["LJ4", "4"], ["LC19", "1"]]},
  {name: "Loled.c1_cap.neg", pads: [["LJ4", "5"], ["LC19", "2"]]},
  {name: "Loled.c2_cap.pos", pads: [["LJ4", "2"], ["LC20", "1"]]},
  {name: "Loled.c2_cap.neg", pads: [["LJ4", "3"], ["LC20", "2"]]},
  {name: "Loled.iref_res.a", pads: [["LJ4", "26"], ["LR11", "1"]]},
  {name: "Loled_rst.nreset", pads: [["LJ4", "14"], ["LU7", "2"], ["LR12", "2"]]},
  ...
  {name: "Lnfc.emc.out1", pads: [["LR13", "1"], ["LL7", "2"], ["LC38", "1"], ["LC40", "1"]]},
  {name: "Lnfc.emc.out2", pads: [["LR14", "1"], ["LL8", "2"], ["LC39", "1"], ["LC41", "1"]]},
  {name: "Lnfc.damp.ant1", pads: [["LANT1", "1"], ["LR15", "2"]]},
  {name: "Lnfc.damp.ant2", pads: [["LANT1", "2"], ["LR16", "2"]]},

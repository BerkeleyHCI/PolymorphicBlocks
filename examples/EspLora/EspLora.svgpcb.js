...
board.setNetlist([
  ...
  {name: "lora.ic.xtal.xtal_out", pads: [["LU4", "4"], ["LX1", "3"]]},
  {name: "lora.ic.rfi_p", pads: [["LU4", "21"], ["LL5", "2"], ["LC16", "1"]]},
  {name: "lora.ic.rfi_n", pads: [["LU4", "22"], ["LL5", "1"], ["LC15", "2"]]},
  {name: "lora.ic.rfo", pads: [["LU4", "23"], ["LL2", "2"], ["LL3", "1"], ["LC13", "2"]]},
  {name: "lora.ic.vr_pa", pads: [["LU4", "24"], ["LC9", "1"], ["LC10", "1"], ["LL2", "1"]]},
  {name: "lora.ic.dio2", pads: [["LU4", "12"], ["LR8", "1"]]},
  {name: "lora.ic.dio3", pads: [["LU4", "6"]]},
  {name: "lora.rf_sw.rf1", pads: [["LU5", "1"], ["LC11", "1"]]},
  {name: "lora.rf_sw.rf2", pads: [["LU5", "3"], ["LC15", "1"]]},
  {name: "lora.rf_sw.rfc", pads: [["LU5", "5"], ["LC12", "2"]]},
  {name: "lora.rf_sw.ic.vdd", pads: [["LU5", "6"], ["LR7", "2"]]},
  {name: "lora.rf_sw.ic.ctrl", pads: [["LU5", "4"], ["LR8", "2"]]},
  ...
  {name: "oled.device.vcomh", pads: [["LJ4", "27"], ["LC21", "1"]]},
  {name: "oled.device.c1p", pads: [["LJ4", "4"], ["LC19", "1"]]},
  ...
  {name: "nfc.ic.xtal.xtal_in", pads: [["LU8", "30"], ["LX2", "1"], ["LC34", "1"]]},
  {name: "nfc.ic.xtal.xtal_out", pads: [["LU8", "29"], ["LX2", "3"], ["LC35", "1"]]},
  {name: "nfc.ic.tx1", pads: [["LU8", "21"], ["LL7", "1"]]},
  {name: "nfc.ic.tx2", pads: [["LU8", "19"], ["LL8", "1"]]},
  {name: "nfc.ic.rxp", pads: [["LU8", "16"], ["LC36", "2"]]},
  {name: "nfc.ic.rxn", pads: [["LU8", "15"], ["LC37", "2"]]},
  {name: "nfc.rx.in1", pads: [["LR13", "1"], ["LL7", "2"], ["LC38", "1"], ["LC40", "1"]]},
  {name: "nfc.rx.in2", pads: [["LR14", "1"], ["LL8", "2"], ["LC39", "1"], ["LC41", "1"]]},
  {name: "nfc.rx.rrx1.b", pads: [["LR13", "2"], ["LC36", "1"]]},
  {name: "nfc.rx.rrx2.b", pads: [["LR14", "2"], ["LC37", "1"]]},
  {name: "nfc.ant.ant1", pads: [["LANT1", "1"], ["LR15", "2"]]},
  {name: "nfc.ant.ant2", pads: [["LANT1", "2"], ["LR16", "2"]]},
  {name: "nfc.damp.in1", pads: [["LR15", "1"], ["LC40", "2"], ["LC42", "1"]]},
  {name: "nfc.damp.in2", pads: [["LR16", "1"], ["LC41", "2"], ["LC43", "1"]]},
  {name: "tx_cpack.pos.0", pads: [["LL3", "2"], ["LC13", "1"], ["LL4", "1"], ["LC44", "1"]]}
])

...
board.setNetlist([
  {name: "Lgnd", pads: [["LJ1", "A1"], ["LJ1", "A12"], ["LJ1", "B1"], ["LJ1", "B12"], ["LJ1", "S1"], ["LR1", "1"], ["LR2", "1"], ["LTP1", "1"], ["LU1", "1"], ["LC1", "2"], ["LC2", "2"], ["LD1", "2"], ["LJ2", "5"], ["LSW1", "2"], ["LU2", "1"], ["LU2", "40"], ["LU2", "41"], ["LC3", "2"], ["LC4", "2"], ["LC5", "2"], ["LU3", "3"], ["LR4", "2"], ["LR5", "2"], ["LR6", "2"], ["LU4", "2"], ["LU4", "20"], ["LU4", "25"], ["LU4", "5"], ["LU4", "8"], ["LX1", "2"], ["LX1", "4"], ["LC6", "2"], ["LC7", "2"], ["LC8", "2"], ["LC9", "2"], ["LC10", "2"], ["LU5", "2"], ["LC14", "2"], ["LC16", "2"], ["LC17", "2"], ["LC18", "2"], ["LJ3", "2"], ["LJ4", "1"], ["LJ4", "10"], ["LJ4", "12"], ["LJ4", "13"], ["LJ4", "15"], ["LJ4", "16"], ["LJ4", "17"], ["LJ4", "21"], ["LJ4", "22"], ["LJ4", "23"], ["LJ4", "24"], ["LJ4", "25"], ["LJ4", "29"], ["LJ4", "30"], ["LJ4", "8"], ["LR11", "1"], ["LC21", "2"], ["LC22", "2"], ["LC23", "2"], ["LC24", "2"], ["LU7", "1"], ["LJ5", "11"], ["LJ5", "6"], ["LU8", "1"], ["LU8", "20"], ["LU8", "3"], ["LU8", "4"], ["LU8", "41"], ["LU8", "9"], ["LC25", "2"], ["LC26", "2"], ["LC27", "2"], ["LC28", "2"], ["LC29", "2"], ["LC30", "2"], ["LC31", "2"], ["LC32", "2"], ["LC33", "2"], ["LX2", "2"], ["LX2", "4"], ["LC34", "2"], ["LC35", "2"], ["LC38", "2"], ["LC39", "2"], ["LC42", "2"], ["LC43", "2"], ["LC44", "2"]]},
  {name: "Lpwr", pads: [["LFB1", "2"], ["LTP2", "1"], ["LU1", "3"], ["LC1", "1"], ["LU8", "12"], ["LU8", "13"], ["LU8", "28"], ["LC25", "1"], ["LC26", "1"], ["LC27", "1"]]},
  {name: "Lv3v3", pads: [["LU1", "2"], ["LC2", "1"], ["LTP3", "1"], ["LD1", "1"], ["LJ2", "1"], ["LU2", "2"], ["LC3", "1"], ["LC4", "1"], ["LR3", "1"], ["LU4", "1"], ["LU4", "10"], ["LU4", "11"], ["LC7", "1"], ["LC8", "1"], ["LR7", "1"], ["LR9", "1"], ["LR10", "1"], ["LJ4", "11"], ["LJ4", "6"], ["LJ4", "9"], ["LC22", "1"], ["LC23", "1"], ["LU7", "3"], ["LR12", "1"], ["LJ5", "4"], ["LU8", "6"], ["LC32", "1"]]},
  {name: "Lusb_chain_0.d_P", pads: [["LJ1", "A6"], ["LJ1", "B6"], ["LU2", "14"], ["LU3", "2"]]},
  {name: "Lusb_chain_0.d_N", pads: [["LJ1", "A7"], ["LJ1", "B7"], ["LU2", "13"], ["LU3", "1"]]},
  {name: "Lusb.pwr", pads: [["LJ1", "A4"], ["LJ1", "A9"], ["LJ1", "B4"], ["LJ1", "B9"], ["LFB1", "1"]]},
  {name: "Lusb.conn.cc.cc1", pads: [["LJ1", "A5"], ["LR1", "2"]]},
  {name: "Lusb.conn.cc.cc2", pads: [["LJ1", "B5"], ["LR2", "2"]]},
  {name: "Lmcu.program_uart_node.a_tx", pads: [["LJ2", "4"], ["LU2", "36"]]},
  {name: "Lmcu.program_uart_node.b_tx", pads: [["LJ2", "3"], ["LU2", "37"]]},
  {name: "Lmcu.program_en_node", pads: [["LJ2", "6"], ["LU2", "3"], ["LR3", "2"], ["LC5", "1"]]},
  {name: "Lmcu.program_boot_node", pads: [["LJ2", "2"], ["LSW1", "1"], ["LU2", "27"]]},
  {name: "Lledr.signal", pads: [["LU2", "34"], ["LD2", "2"]]},
  {name: "Lledr.package.k", pads: [["LD2", "1"], ["LR4", "1"]]},
  {name: "Lledg.signal", pads: [["LU2", "35"], ["LD3", "2"]]},
  {name: "Lledg.package.k", pads: [["LD3", "1"], ["LR5", "1"]]},
  {name: "Lledb.signal", pads: [["LU2", "39"], ["LD4", "2"]]},
  {name: "Lledb.package.k", pads: [["LD4", "1"], ["LR6", "1"]]},
  {name: "Llora.reset", pads: [["LU2", "12"], ["LU4", "15"], ["LTP8", "1"]]},
  {name: "Llora.spi.sck", pads: [["LU2", "5"], ["LU4", "18"], ["LTP4", "1"]]},
  {name: "Llora.spi.mosi", pads: [["LU2", "6"], ["LU4", "17"], ["LTP5", "1"]]},
  {name: "Llora.spi.miso", pads: [["LU2", "15"], ["LU4", "16"], ["LTP6", "1"]]},
  {name: "Llora.cs", pads: [["LU2", "7"], ["LU4", "19"], ["LTP7", "1"]]},
  {name: "Llora.irq", pads: [["LU2", "31"], ["LU4", "13"], ["LTP9", "1"]]},
  {name: "Llora.busy", pads: [["LU2", "33"], ["LU4", "14"], ["LTP10", "1"]]},
  {name: "Llora.ic.vreg", pads: [["LU4", "7"], ["LC6", "1"], ["LL1", "2"]]},
  {name: "Llora.ic.dcc_sw", pads: [["LU4", "9"], ["LL1", "1"]]},
  {name: "Llora.ic.xtal.xtal_in", pads: [["LU4", "3"], ["LX1", "1"]]},
  {name: "Llora.ic.xtal.xtal_out", pads: [["LU4", "4"], ["LX1", "3"]]},
  {name: "Llora.ic.rfi_p", pads: [["LU4", "21"], ["LL5", "2"], ["LC16", "1"]]},
  {name: "Llora.ic.rfi_n", pads: [["LU4", "22"], ["LL5", "1"], ["LC15", "2"]]},
  {name: "Llora.ic.rfo", pads: [["LU4", "23"], ["LL2", "2"], ["LL3", "1"], ["LC13", "2"]]},
  {name: "Llora.ic.vr_pa", pads: [["LU4", "24"], ["LC9", "1"], ["LC10", "1"], ["LL2", "1"]]},
  {name: "Llora.ic.dio2", pads: [["LU4", "12"], ["LR8", "1"]]},
  {name: "Llora.ic.dio3", pads: [["LU4", "6"]]},
  {name: "Llora.rf_sw.rf1", pads: [["LU5", "1"], ["LC11", "1"]]},
  {name: "Llora.rf_sw.rf2", pads: [["LU5", "3"], ["LC15", "1"]]},
  {name: "Llora.rf_sw.rfc", pads: [["LU5", "5"], ["LC12", "2"]]},
  {name: "Llora.rf_sw.ic.vdd", pads: [["LU5", "6"], ["LR7", "2"]]},
  {name: "Llora.rf_sw.ic.ctrl", pads: [["LU5", "4"], ["LR8", "2"]]},
  {name: "Llora.tx_dcblock.neg", pads: [["LC11", "2"], ["LC14", "1"], ["LL4", "2"]]},
  {name: "Llora.rfc_dcblock.pos", pads: [["LC12", "1"], ["LC17", "1"], ["LL6", "1"]]},
  {name: "Llora.ant_pi.output", pads: [["LC18", "1"], ["LL6", "2"], ["LJ3", "1"]]},
  {name: "Li2c_pull.i2c.scl", pads: [["LU2", "10"], ["LR9", "2"], ["LTP11", "1"], ["LJ4", "18"], ["LU8", "7"]]},
  {name: "Li2c_pull.i2c.sda", pads: [["LU2", "11"], ["LR10", "2"], ["LTP12", "1"], ["LJ4", "19"], ["LJ4", "20"], ["LU8", "5"]]},
  {name: "Loled.reset", pads: [["LJ4", "14"], ["LU7", "2"], ["LR12", "2"]]},
  {name: "Loled.device.vcc", pads: [["LJ4", "28"], ["LC24", "1"]]},
  {name: "Loled.device.iref", pads: [["LJ4", "26"], ["LR11", "2"]]},
  {name: "Loled.device.vcomh", pads: [["LJ4", "27"], ["LC21", "1"]]},
  {name: "Loled.device.c1p", pads: [["LJ4", "4"], ["LC19", "1"]]},
  {name: "Loled.device.c1n", pads: [["LJ4", "5"], ["LC19", "2"]]},
  {name: "Loled.device.c2p", pads: [["LJ4", "2"], ["LC20", "1"]]},
  {name: "Loled.device.c2n", pads: [["LJ4", "3"], ["LC20", "2"]]},
  ...
  {name: "Lnfc.reset", pads: [["LU2", "32"], ["LU8", "10"]]},
  {name: "Lnfc.irq", pads: [["LU2", "24"], ["LU8", "8"]]},
  ...
  {name: "Lnfc.rx.in1", pads: [["LR13", "1"], ["LL7", "2"], ["LC38", "1"], ["LC40", "1"]]},
  {name: "Lnfc.rx.in2", pads: [["LR14", "1"], ["LL8", "2"], ["LC39", "1"], ["LC41", "1"]]},
  {name: "Lnfc.rx.rrx1.b", pads: [["LR13", "2"], ["LC36", "1"]]},
  {name: "Lnfc.rx.rrx2.b", pads: [["LR14", "2"], ["LC37", "1"]]},
  {name: "Lnfc.ant.ant1", pads: [["LANT1", "1"], ["LR15", "2"]]},
  {name: "Lnfc.ant.ant2", pads: [["LANT1", "2"], ["LR16", "2"]]},
  {name: "Lnfc.damp.in1", pads: [["LR15", "1"], ["LC40", "2"], ["LC42", "1"]]},
  {name: "Lnfc.damp.in2", pads: [["LR16", "1"], ["LC41", "2"], ["LC43", "1"]]},
  {name: "Ltx_cpack.pos.0", pads: [["LL3", "2"], ["LC13", "1"], ["LL4", "1"], ["LC44", "1"]]}
])

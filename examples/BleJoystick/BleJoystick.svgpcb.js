...
const JH1 = board.add(JlcToolingHole_1_152mm, {
  translate: pt(0.936, 1.640), rotate: 0,
  id: 'JH1'
})
// jlc_th.th2
const JH2 = board.add(JlcToolingHole_1_152mm, {
  translate: pt(0.975, 1.640), rotate: 0,
  id: 'JH2'
})
// jlc_th.th3
...
const JJ1 = board.add(JST_PH_B2B_PH_K_1x02_P2_00mm_Vertical, {
  translate: pt(0.487, 1.429), rotate: 0,
  id: 'JJ1'
})
// usb.conn
...
const JTP1 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(1.566, 1.337), rotate: 0,
  id: 'JTP1'
})
// tp_usb.tp
const JTP2 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(1.817, 1.337), rotate: 0,
  id: 'JTP2'
})
// tp_gnd.tp
const JTP3 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(2.067, 1.337), rotate: 0,
  id: 'JTP3'
})
// vbat_sense.ic
...
const JTP4 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(0.066, 1.678), rotate: 0,
  id: 'JTP4'
})
// prot_3v3.diode
const JD3 = board.add(D_SOD_323, {
  translate: pt(0.314, 1.678), rotate: 0,
  id: 'JD3'
})
// tp_vgate.tp
const JTP5 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(0.561, 1.678), rotate: 0,
  id: 'JTP5'
})
// chg.ic
...
const JU5 = board.add(SOT_23, {
  translate: pt(0.821, 1.707), rotate: 0,
  id: 'JU5'
})
// ledr.package
const JD4 = board.add(LED_0603_1608Metric, {
  translate: pt(1.089, 1.328), rotate: 0,
  id: 'JD4'
})
// ledr.res
const JR9 = board.add(R_0603_1608Metric, {
  translate: pt(1.089, 1.425), rotate: 0,
  id: 'JR9'
})
// i2c_pull.scl_res.res
const JR10 = board.add(R_0603_1608Metric, {
  translate: pt(1.324, 1.328), rotate: 0,
  id: 'JR10'
})
// i2c_pull.sda_res.res
const JR11 = board.add(R_0603_1608Metric, {
  translate: pt(1.324, 1.425), rotate: 0,
  id: 'JR11'
})
// tp_i2c.tp_scl.tp
const JTP6 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(0.846, 1.337), rotate: 0,
  id: 'JTP6'
})
// tp_i2c.tp_sda.tp
const JTP7 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(0.846, 1.451), rotate: 0,
  id: 'JTP7'
})
// imu.ic
const JU6 = board.add(Bosch_LGA_14_3x2_5mm_P0_5mm, {
  translate: pt(0.073, 1.362), rotate: 0,
  id: 'JU6'
})
// imu.vdd_cap.cap
const JC8 = board.add(C_0603_1608Metric, {
  translate: pt(0.058, 1.493), rotate: 0,
  id: 'JC8'
})
// imu.vddio_cap.cap
const JC9 = board.add(C_0603_1608Metric, {
  translate: pt(0.214, 1.493), rotate: 0,
  id: 'JC9'
})
// mag.ic
...
board.setNetlist([
  ...
  {name: "Jvbat_sense.i2c.scl", pads: [["JU1", "5"], ["JU4", "12"], ["JR10", "2"], ["JTP6", "1"], ["JU6", "13"], ["JU7", "1"], ["JJ7", "3"]]},
  {name: "Jvbat_sense.i2c.sda", pads: [["JU1", "6"], ["JU4", "13"], ["JR11", "2"], ["JTP7", "1"], ["JU6", "14"], ["JU7", "16"], ["JJ7", "4"]]},
  {name: "Jvbat_sense.sense_neg", pads: [["JU1", "2"], ["JR3", "2"], ["JU2", "2"], ["JC2", "1"]]},
  {name: "Jgate.btn_out", pads: [["JD2", "2"], ["JU4", "5"]]},
  {name: "Jgate.btn_in", pads: [["JD1", "1"], ["JD2", "1"], ["JJ4", "4"]]},
  {name: "Jgate.control", pads: [["JR5", "2"], ["JQ2", "1"], ["JU4", "4"]]},
  {name: "Jgate.pull_res.b", pads: [["JR4", "2"], ["JQ1", "1"], ["JQ2", "3"], ["JD1", "2"]]},
  {name: "Jchg.stat", pads: [["JU3", "1"]]},
  {name: "Jchg.prog_ctl", pads: [["JQ3", "1"], ["JU4", "10"]]},
  ...
  {name: "Jledr.signal", pads: [["JU4", "7"], ["JR9", "2"]]},
  ...
  {name: "Jstick.pwr", pads: [["JU4", "3"], ["JJ4", "2"]]},
  {name: "Jstick.ax1", pads: [["JU4", "11"], ["JJ4", "5"]]},
  {name: "Jstick.ax2", pads: [["JU4", "9"], ["JJ4", "6"]]},
  {name: "Jbtns.io0", pads: [["JU4", "8"], ["JJ7", "5"]]}
])

const limit0 = pt(-0.07874015748031496, -0.07874015748031496);
const limit1 = pt(2.4173228346456694, 1.833070866141732);

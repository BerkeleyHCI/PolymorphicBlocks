...
const JU7 = board.add(LGA_16_3x3mm_P0_5mm, {
  translate: pt(1.667, 0.905), rotate: 0,
  id: 'JU7'
})
// mag.vdd_cap.cap
...
board.setNetlist([
  ...
  {name: "vbat_sense.i2c.scl", pads: [["JU1", "5"], ["JU4", "26"], ["JR10", "2"], ["JTP4", "1"], ["JU6", "13"], ["JU7", "1"], ["JJ7", "3"]]},
  {name: "vbat_sense.i2c.sda", pads: [["JU1", "6"], ["JU4", "27"], ["JR11", "2"], ["JTP5", "1"], ["JU6", "14"], ["JU7", "16"], ["JJ7", "4"]]},
  {name: "vbat_sense.sense_pwr_in", pads: [["JU1", "1"], ["JR3", "1"], ["JQ1", "3"]]},
  {name: "gate.btn_out", pads: [["JD2", "2"], ["JU4", "13"]]},
  {name: "gate.btn_in", pads: [["JD1", "1"], ["JD2", "1"], ["JJ4", "6"]]},
  {name: "gate.control", pads: [["JR5", "2"], ["JQ2", "1"], ["JU4", "15"]]},
  {name: "gate.pull_res.b", pads: [["JR4", "2"], ["JQ1", "1"], ["JQ2", "3"], ["JD1", "2"]]},
  {name: "chg.stat", pads: [["JU3", "1"]]},
  {name: "chg.prog_ctl", pads: [["JQ3", "1"], ["JU4", "2"]]},
  {name: "chg.ic.prog", pads: [["JU3", "5"], ["JR6", "2"]]},
  {name: "chg.prog_res.gnd", pads: [["JR6", "1"], ["JQ3", "3"]]},
  {name: "mcu.swd_node.swdio", pads: [["JU4", "32"], ["JJ3", "2"]]},
  {name: "mcu.swd_node.swclk", pads: [["JU4", "31"], ["JJ3", "4"]]},
  {name: "mcu.reset_node", pads: [["JU4", "21"], ["JJ3", "3"]]},
  {name: "mcu.swd.swo", pads: [["JJ3", "6"]]},
  {name: "mcu.usb_res.interior.dp", pads: [["JU4", "24"], ["JR7", "2"]]},
  {name: "mcu.usb_res.interior.dm", pads: [["JU4", "23"], ["JR8", "2"]]},
  {name: "ledr.signal", pads: [["JU4", "10"], ["JD4", "2"]]},

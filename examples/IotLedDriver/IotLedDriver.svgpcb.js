...
const LC5 = board.add(C_0805_2012Metric, {
  translate: pt(0.459, 0.322), rotate: 0,
  id: 'LC5'
})
// mcu.vdda_cap0.cap
const LC6 = board.add(C_0402_1005Metric, {
  translate: pt(0.573, 0.459), rotate: 0,
  id: 'LC6'
})
// mcu.vdda_cap1.cap
const LC7 = board.add(C_0402_1005Metric, {
  translate: pt(0.684, 0.459), rotate: 0,
  id: 'LC7'
})
// mcu.vddrtc_cap.cap
const LC8 = board.add(C_0402_1005Metric, {
  translate: pt(0.036, 0.556), rotate: 0,
  id: 'LC8'
})
// mcu.vddcpu_cap.cap
const LC9 = board.add(C_0402_1005Metric, {
  translate: pt(0.147, 0.556), rotate: 0,
  id: 'LC9'
})
// mcu.vddspi_cap.cap
const LC10 = board.add(C_0402_1005Metric, {
  translate: pt(0.258, 0.556), rotate: 0,
  id: 'LC10'
})
// mcu.ant.ant_a
const LANT1 = board.add(D_1206_3216Metric, {
  translate: pt(0.263, 0.328), rotate: 0,
  id: 'LANT1'
})
// mcu.ant.ant_b.conn
const LJ2 = board.add(U_FL_Hirose_U_FL_R_SMT_1_Vertical, {
  translate: pt(0.363, 0.098), rotate: 0,
  id: 'LJ2'
})
// mcu.pi.c1
const LC11 = board.add(C_0603_1608Metric, {
  translate: pt(0.624, 0.312), rotate: 0,
  id: 'LC11'
})
// mcu.pi.c2
const LC12 = board.add(C_0603_1608Metric, {
  translate: pt(0.058, 0.470), rotate: 0,
  id: 'LC12'
})
// mcu.pi.l
const LL2 = board.add(L_0603_1608Metric, {
  translate: pt(0.214, 0.470), rotate: 0,
  id: 'LL2'
})
// mcu.vdd3p3_l_cap.cap
const LC13 = board.add(C_0402_1005Metric, {
  translate: pt(0.369, 0.556), rotate: 0,
  id: 'LC13'
})
// mcu.vdd3p3_cap.cap
const LC14 = board.add(C_0402_1005Metric, {
  translate: pt(0.480, 0.556), rotate: 0,
  id: 'LC14'
})
// mcu.vdd3p3_l.ind
const LL3 = board.add(L_0402_1005Metric, {
  translate: pt(0.348, 0.459), rotate: 0,
  id: 'LL3'
})
// mcu.crystal.package
const LX1 = board.add(Crystal_SMD_2520_4Pin_2_5x2_0mm, {
  translate: pt(0.067, 0.343), rotate: 0,
  id: 'LX1'
})
// mcu.crystal.cap_a
const LC15 = board.add(C_0402_1005Metric, {
  translate: pt(0.591, 0.556), rotate: 0,
  id: 'LC15'
})
// mcu.crystal.cap_b
const LC16 = board.add(C_0402_1005Metric, {
  translate: pt(0.702, 0.556), rotate: 0,
  id: 'LC16'
})
// mcu.prog.conn
const LJ3 = board.add(Tag_Connect_TC2030_IDC_NL_2x03_P1_27mm_Vertical, {
  translate: pt(0.630, 0.079), rotate: 0,
  id: 'LJ3'
})
// mcu.en_pull.rc.r
const LR4 = board.add(R_0402_1005Metric, {
  translate: pt(0.461, 0.459), rotate: 0,
  id: 'LR4'
})
// mcu.en_pull.rc.c
const LC17 = board.add(C_0402_1005Metric, {
  translate: pt(0.036, 0.631), rotate: 0,
  id: 'LC17'
})
// ledr.package
const LD2 = board.add(LED_0603_1608Metric, {
  translate: pt(0.847, 1.285), rotate: 0,
  id: 'LD2'
})
// ledr.res
const LR5 = board.add(R_0402_1005Metric, {
  translate: pt(0.825, 1.372), rotate: 0,
  id: 'LR5'
})
// v12_sense.div.top_res
const LR6 = board.add(R_0402_1005Metric, {
  translate: pt(1.060, 1.274), rotate: 0,
  id: 'LR6'
})
// v12_sense.div.bottom_res
const LR7 = board.add(R_0402_1005Metric, {
  translate: pt(1.060, 1.351), rotate: 0,
  id: 'LR7'
})
// qwiic.conn
const LJ4 = board.add(JST_SH_SM04B_SRSS_TB_1x04_1MP_P1_00mm_Horizontal, {
  translate: pt(0.154, 1.385), rotate: 0,
  id: 'LJ4'
})
// qwiic_pwr_res.res
const LR8 = board.add(R_0402_1005Metric, {
  translate: pt(0.689, 1.651), rotate: 0,
  id: 'LR8'
})
// qwiic_pull.scl_res.res
const LR9 = board.add(R_0402_1005Metric, {
  translate: pt(1.251, 1.274), rotate: 0,
  id: 'LR9'
})
// qwiic_pull.sda_res.res
const LR10 = board.add(R_0402_1005Metric, {
  translate: pt(1.251, 1.351), rotate: 0,
  id: 'LR10'
})
// tof.ic
const LU3 = board.add(ST_VL53L0X, {
  translate: pt(0.522, 1.313), rotate: 0,
  id: 'LU3'
})
// tof.vdd_cap[0].cap
const LC18 = board.add(C_0402_1005Metric, {
  translate: pt(0.634, 1.428), rotate: 0,
  id: 'LC18'
})
// tof.vdd_cap[1].cap
const LC19 = board.add(C_0805_2012Metric, {
  translate: pt(0.492, 1.448), rotate: 0,
  id: 'LC19'
})
// tof_pull.scl_res.res
const LR11 = board.add(R_0402_1005Metric, {
  translate: pt(1.442, 1.274), rotate: 0,
  id: 'LR11'
})
// tof_pull.sda_res.res
const LR12 = board.add(R_0402_1005Metric, {
  translate: pt(1.442, 1.351), rotate: 0,
  id: 'LR12'
})
// led_drv[0].ic
const LU4 = board.add(SOT_23_6, {
  translate: pt(1.715, 0.067), rotate: 0,
  id: 'LU4'
})
// led_drv[0].cap.cap
const LC20 = board.add(C_0402_1005Metric, {
  translate: pt(1.449, 0.352), rotate: 0,
  id: 'LC20'
})
// led_drv[0].boot_cap
const LC21 = board.add(C_0402_1005Metric, {
  translate: pt(1.560, 0.352), rotate: 0,
  id: 'LC21'
})
// led_drv[0].rsense.res.res
const LR13 = board.add(R_0603_1608Metric, {
  translate: pt(1.818, 0.246), rotate: 0,
  id: 'LR13'
})
// led_drv[0].power_path.inductor
const LL4 = board.add(L_Sunlord_SWPA4030S, {
  translate: pt(1.504, 0.089), rotate: 0,
  id: 'LL4'
})
// led_drv[0].power_path.in_cap.cap
const LC22 = board.add(C_0805_2012Metric, {
  translate: pt(1.480, 0.256), rotate: 0,
  id: 'LC22'
})
// led_drv[0].power_path.out_cap.cap
const LC23 = board.add(C_0805_2012Metric, {
  translate: pt(1.654, 0.256), rotate: 0,
  id: 'LC23'
})
// led_drv[1].ic
const LU5 = board.add(SOT_23_6, {
  translate: pt(0.301, 0.835), rotate: 0,
  id: 'LU5'
})
// led_drv[1].cap.cap
const LC24 = board.add(C_0402_1005Metric, {
  translate: pt(0.036, 1.120), rotate: 0,
  id: 'LC24'
})
// led_drv[1].boot_cap
const LC25 = board.add(C_0402_1005Metric, {
  translate: pt(0.147, 1.120), rotate: 0,
  id: 'LC25'
})
// led_drv[1].rsense.res.res
const LR14 = board.add(R_0603_1608Metric, {
  translate: pt(0.405, 1.014), rotate: 0,
  id: 'LR14'
})
// led_drv[1].power_path.inductor
const LL5 = board.add(L_Sunlord_SWPA4030S, {
  translate: pt(0.091, 0.857), rotate: 0,
  id: 'LL5'
})
// led_drv[1].power_path.in_cap.cap
const LC26 = board.add(C_0805_2012Metric, {
  translate: pt(0.067, 1.024), rotate: 0,
  id: 'LC26'
})
// led_drv[1].power_path.out_cap.cap
const LC27 = board.add(C_0805_2012Metric, {
  translate: pt(0.240, 1.024), rotate: 0,
  id: 'LC27'
})
// led_drv[2].ic
const LU6 = board.add(SOT_23_6, {
  translate: pt(0.882, 0.835), rotate: 0,
  id: 'LU6'
})
// led_drv[2].cap.cap
const LC28 = board.add(C_0402_1005Metric, {
  translate: pt(0.617, 1.120), rotate: 0,
  id: 'LC28'
})
// led_drv[2].boot_cap
const LC29 = board.add(C_0402_1005Metric, {
  translate: pt(0.728, 1.120), rotate: 0,
  id: 'LC29'
})
// led_drv[2].rsense.res.res
const LR15 = board.add(R_0603_1608Metric, {
  translate: pt(0.986, 1.014), rotate: 0,
  id: 'LR15'
})
// led_drv[2].power_path.inductor
const LL6 = board.add(L_Sunlord_SWPA4030S, {
  translate: pt(0.672, 0.857), rotate: 0,
  id: 'LL6'
})
// led_drv[2].power_path.in_cap.cap
const LC30 = board.add(C_0805_2012Metric, {
  translate: pt(0.648, 1.024), rotate: 0,
  id: 'LC30'
})
// led_drv[2].power_path.out_cap.cap
const LC31 = board.add(C_0805_2012Metric, {
  translate: pt(0.821, 1.024), rotate: 0,
  id: 'LC31'
})
// led_drv[3].ic
const LU7 = board.add(SOT_23_6, {
  translate: pt(1.463, 0.835), rotate: 0,
  id: 'LU7'
})
// led_drv[3].cap.cap
const LC32 = board.add(C_0402_1005Metric, {
  translate: pt(1.198, 1.120), rotate: 0,
  id: 'LC32'
})
// led_drv[3].boot_cap
const LC33 = board.add(C_0402_1005Metric, {
  translate: pt(1.309, 1.120), rotate: 0,
  id: 'LC33'
})
// led_drv[3].rsense.res.res
const LR16 = board.add(R_0603_1608Metric, {
  translate: pt(1.567, 1.014), rotate: 0,
  id: 'LR16'
})
// led_drv[3].power_path.inductor
const LL7 = board.add(L_Sunlord_SWPA4030S, {
  translate: pt(1.253, 0.857), rotate: 0,
  id: 'LL7'
})
// led_drv[3].power_path.in_cap.cap
const LC34 = board.add(C_0805_2012Metric, {
  translate: pt(1.229, 1.024), rotate: 0,
  id: 'LC34'
})
// led_drv[3].power_path.out_cap.cap
const LC35 = board.add(C_0805_2012Metric, {
  translate: pt(1.402, 1.024), rotate: 0,
  id: 'LC35'
})

board.setNetlist([
  {name: "Lgnd", pads: [["LJ1", "1"], ["LTP2", "1"], ["LU1", "1"], ["LD1", "2"], ["LU2", "33"], ["LR5", "2"], ["LJ4", "1"], ["LU3", "2"], ["LU3", "3"], ["LU3", "4"], ["LU3", "6"], ["LU3", "12"], ["LU4", "3"], ["LU5", "3"], ["LU6", "3"], ["LU7", "3"], ["LR7", "2"], ["LC1", "2"], ["LC5", "2"], ["LC6", "2"], ["LC7", "2"], ["LC8", "2"], ["LC9", "2"], ["LC10", "2"], ["LC13", "2"], ["LC14", "2"], ["LX1", "2"], ["LX1", "4"], ["LJ3", "5"], ["LC18", "2"], ["LC19", "2"], ["LC20", "2"], ["LC24", "2"], ["LC28", "2"], ["LC32", "2"], ["LR2", "2"], ["LJ2", "2"], ["LC17", "2"], ["LC11", "2"], ["LC12", "2"], ["LC15", "2"], ["LC16", "2"], ["LC3", "2"], ["LC4", "2"], ["LR13", "1"], ["LC22", "2"], ["LC23", "2"], ["LR14", "1"], ["LC26", "2"], ["LC27", "2"], ["LR15", "1"], ["LC30", "2"], ["LC31", "2"], ["LR16", "1"], ["LC34", "2"], ["LC35", "2"]]},
  ...
  {name: "Lv3v3", pads: [["LTP3", "1"], ["LD1", "1"], ["LU2", "31"], ["LU2", "32"], ["LU2", "11"], ["LU2", "17"], ["LU2", "18"], ["LR8", "1"], ["LU3", "1"], ["LU3", "11"], ["LR1", "1"], ["LU2", "14"], ["LU2", "6"], ["LU3", "5"], ["LC5", "1"], ["LC6", "1"], ["LC7", "1"], ["LC8", "1"], ["LC9", "1"], ["LC10", "1"], ["LC13", "1"], ["LL3", "1"], ["LJ3", "1"], ["LR9", "1"], ["LR10", "1"], ["LC18", "1"], ["LC19", "1"], ["LR11", "1"], ["LR12", "1"], ["LR4", "1"], ["LL1", "2"], ["LC4", "1"]]},
  {name: "Lmcu.program_boot_node", pads: [["LD2", "2"], ["LU2", "15"], ["LJ3", "2"]]},
  {name: "Lv12_sense.output", pads: [["LU2", "4"], ["LR6", "2"], ["LR7", "1"]]},
  {name: "Lqwiic_pwr_res.pwr_out", pads: [["LR8", "2"], ["LJ4", "2"], ["LU2", "16"]]},
  {name: "Lqwiic_i2c.scl", pads: [["LU2", "25"], ["LR9", "2"], ["LJ4", "4"]]},
  {name: "Lqwiic_i2c.sda", pads: [["LU2", "26"], ["LJ4", "3"], ["LR10", "2"]]},
  ...
  {name: "Lmcu.program_uart_node.a_tx", pads: [["LU2", "28"], ["LJ3", "3"]]},
  {name: "Lmcu.program_uart_node.b_tx", pads: [["LU2", "27"], ["LJ3", "4"]]},
  {name: "Lmcu.program_en_node", pads: [["LU2", "7"], ["LJ3", "6"], ["LR4", "2"], ["LC17", "1"]]},
  {name: "Lmcu.ic.lna_in", pads: [["LU2", "1"], ["LC11", "1"], ["LL2", "1"]]},
  {name: "Lmcu.pi.output", pads: [["LL2", "2"], ["LC12", "1"], ["LANT1", "1"], ["LJ2", "1"]]},
...
const limit1 = pt(2.0978346456692916, 1.8251968503937006);

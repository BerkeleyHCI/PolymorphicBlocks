...
board.setNetlist([
  ...
  {name: "Lreg_3v3.boot_cap.pos", pads: [["LU1", "6"], ["LC2", "1"]]},
  {name: "Lreg_3v3.boot_cap.neg", pads: [["LU1", "2"], ["LC2", "2"], ["LL1", "1"]]},
  {name: "Lreg_3v3.en_res.b", pads: [["LU1", "5"], ["LR3", "2"]]},
  ...
  {name: "Lmcu.pi.output", pads: [["LANT1", "1"], ["LC12", "1"], ["LL2", "2"]]},
  {name: "Lledr.res.a", pads: [["LD2", "1"], ["LR5", "1"]]},
  {name: "Lv12_sense.output", pads: [["LU2", "4"], ["LR6", "2"], ["LR7", "1"]]},
  {name: "Lqwiic_pwr_res.pwr_out", pads: [["LU2", "16"], ["LJ3", "2"], ["LR8", "2"]]},
  {name: "Lqwiic_i2c.scl", pads: [["LU2", "25"], ["LJ3", "4"], ["LR9", "2"]]},
  ...
  {name: "Lled_drv[0].boot_cap.pos", pads: [["LU4", "6"], ["LC21", "1"]]},
  {name: "Lled_drv[0].boot_cap.neg", pads: [["LU4", "5"], ["LC21", "2"], ["LL4", "1"]]},
  {name: "Lled_drv[1].leda", pads: [["LL5", "2"], ["LC27", "1"]]},
  {name: "Lled_drv[1].ledk", pads: [["LU5", "1"], ["LR14", "2"]]},
  {name: "Lled_drv[1].pwm", pads: [["LU2", "8"], ["LU5", "2"]]},
  {name: "Lled_drv[1].boot_cap.pos", pads: [["LU5", "6"], ["LC25", "1"]]},
  {name: "Lled_drv[1].boot_cap.neg", pads: [["LU5", "5"], ["LC25", "2"], ["LL5", "1"]]},
  {name: "Lled_drv[2].leda", pads: [["LL6", "2"], ["LC31", "1"]]},
  {name: "Lled_drv[2].ledk", pads: [["LU6", "1"], ["LR15", "2"]]},
  {name: "Lled_drv[2].pwm", pads: [["LU2", "9"], ["LU6", "2"]]},
  {name: "Lled_drv[2].boot_cap.pos", pads: [["LU6", "6"], ["LC29", "1"]]},
  {name: "Lled_drv[2].boot_cap.neg", pads: [["LU6", "5"], ["LC29", "2"], ["LL6", "1"]]},
  {name: "Lled_drv[3].leda", pads: [["LL7", "2"], ["LC35", "1"]]},
  {name: "Lled_drv[3].ledk", pads: [["LU7", "1"], ["LR16", "2"]]},
  {name: "Lled_drv[3].pwm", pads: [["LU2", "10"], ["LU7", "2"]]},
  {name: "Lled_drv[3].boot_cap.pos", pads: [["LU7", "6"], ["LC33", "1"]]},
  {name: "Lled_drv[3].boot_cap.neg", pads: [["LU7", "5"], ["LC33", "2"], ["LL7", "1"]]}
])

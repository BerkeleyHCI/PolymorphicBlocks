...
board.setNetlist([
  {name: "gnd", pads: [["LJ1", "1"], ["LTP2", "1"], ["LU1", "1"], ["LR2", "2"], ["LC1", "2"], ["LC3", "2"], ["LC4", "2"], ["LD1", "2"], ["LX1", "2"], ["LX1", "4"], ["LC5", "2"], ["LC6", "2"], ["LJ2", "5"], ["LU2", "33"], ["LC7", "2"], ["LC8", "2"], ["LC9", "2"], ["LC10", "2"], ["LC11", "2"], ["LC12", "2"], ["LC13", "2"], ["LC14", "2"], ["LC15", "2"], ["LC16", "2"], ["LC17", "2"], ["LR5", "2"], ["LR7", "2"], ["LJ3", "1"], ["LU3", "12"], ["LU3", "2"], ["LU3", "3"], ["LU3", "4"], ["LU3", "6"], ["LC18", "2"], ["LC19", "2"], ["LU4", "3"], ["LC20", "2"], ["LR13", "1"], ["LC22", "2"], ["LC23", "2"], ["LU5", "3"], ["LC24", "2"], ["LR14", "1"], ["LC26", "2"], ["LC27", "2"], ["LU6", "3"], ["LC28", "2"], ["LR15", "1"], ["LC30", "2"], ["LC31", "2"], ["LU7", "3"], ["LC32", "2"], ["LR16", "1"], ["LC34", "2"], ["LC35", "2"]]},
  {name: "v12", pads: [["LJ1", "2"], ["LTP1", "1"], ["LU1", "3"], ["LC1", "1"], ["LC3", "1"], ["LR3", "1"], ["LR6", "1"], ["LU4", "4"], ["LC20", "1"], ["LC22", "1"], ["LU5", "4"], ["LC24", "1"], ["LC26", "1"], ["LU6", "4"], ["LC28", "1"], ["LC30", "1"], ["LU7", "4"], ["LC32", "1"], ["LC34", "1"]]},
  {name: "v3v3", pads: [["LR1", "1"], ["LL1", "2"], ["LC4", "1"], ["LTP3", "1"], ["LD1", "1"], ["LJ2", "1"], ["LU2", "11"], ["LU2", "14"], ["LU2", "17"], ["LU2", "18"], ["LU2", "31"], ["LU2", "32"], ["LU2", "6"], ["LC7", "1"], ["LC8", "1"], ["LC9", "1"], ["LC10", "1"], ["LC11", "1"], ["LC12", "1"], ["LC15", "1"], ["LL3", "1"], ["LR4", "1"], ["LR8", "1"], ["LR9", "1"], ["LR10", "1"], ["LU3", "1"], ["LU3", "11"], ["LU3", "5"], ["LC18", "1"], ["LC19", "1"], ["LR11", "1"], ["LR12", "1"]]},
  {name: "reg_3v3.ic.sw", pads: [["LU1", "2"], ["LC2", "2"], ["LL1", "1"]]},
  {name: "reg_3v3.ic.fb", pads: [["LU1", "4"], ["LR1", "2"], ["LR2", "1"]]},
  {name: "reg_3v3.ic.boot", pads: [["LU1", "6"], ["LC2", "1"]]},
  {name: "reg_3v3.ic.en", pads: [["LU1", "5"], ["LR3", "2"]]},
  {name: "mcu.xtal_node.xi", pads: [["LX1", "1"], ["LC5", "1"], ["LU2", "30"]]},
  {name: "mcu.xtal_node.xo", pads: [["LX1", "3"], ["LC6", "1"], ["LU2", "29"]]},
  {name: "mcu.program_uart_node.a_tx", pads: [["LJ2", "4"], ["LU2", "27"]]},
  {name: "mcu.program_uart_node.b_tx", pads: [["LJ2", "3"], ["LU2", "28"]]},
  {name: "mcu.program_en_node", pads: [["LJ2", "6"], ["LU2", "7"], ["LR4", "2"], ["LC17", "1"]]},
  {name: "mcu.program_boot_node", pads: [["LJ2", "2"], ["LU2", "15"], ["LD2", "2"]]},
  {name: "mcu.ic.vdd3p3", pads: [["LU2", "2"], ["LU2", "3"], ["LC16", "1"], ["LL3", "2"]]},
  {name: "mcu.ic.lna_in", pads: [["LU2", "1"], ["LC13", "1"], ["LL2", "1"]]},
  {name: "mcu.ant.a", pads: [["LANT1", "1"], ["LC14", "1"], ["LL2", "2"]]},
  {name: "ledr.package.k", pads: [["LD2", "1"], ["LR5", "1"]]},
  {name: "v12_sense.output", pads: [["LU2", "4"], ["LR6", "2"], ["LR7", "1"]]},
  {name: "qwiic.pwr", pads: [["LU2", "16"], ["LJ3", "2"], ["LR8", "2"]]},
  {name: "qwiic_i2c.scl", pads: [["LU2", "25"], ["LJ3", "4"], ["LR9", "2"]]},
  {name: "qwiic_i2c.sda", pads: [["LU2", "26"], ["LJ3", "3"], ["LR10", "2"]]},
  {name: "tof.i2c.scl", pads: [["LU2", "12"], ["LU3", "10"], ["LR11", "2"]]},
  {name: "tof.i2c.sda", pads: [["LU2", "13"], ["LU3", "9"], ["LR12", "2"]]},
  {name: "tof.ic.gpio1", pads: [["LU3", "7"]]},
  {name: "led_drv[0].pwm", pads: [["LU2", "5"], ["LU4", "2"]]},
  {name: "led_drv[0].leda", pads: [["LL4", "2"], ["LC23", "1"]]},
  {name: "led_drv[0].ledk", pads: [["LU4", "1"], ["LR13", "2"]]},
  {name: "led_drv[0].ic.sw", pads: [["LU4", "5"], ["LC21", "2"], ["LL4", "1"]]},
  {name: "led_drv[0].ic.boot", pads: [["LU4", "6"], ["LC21", "1"]]},
  {name: "led_drv[1].pwm", pads: [["LU2", "8"], ["LU5", "2"]]},
  {name: "led_drv[1].leda", pads: [["LL5", "2"], ["LC27", "1"]]},
  {name: "led_drv[1].ledk", pads: [["LU5", "1"], ["LR14", "2"]]},
  {name: "led_drv[1].ic.sw", pads: [["LU5", "5"], ["LC25", "2"], ["LL5", "1"]]},
  {name: "led_drv[1].ic.boot", pads: [["LU5", "6"], ["LC25", "1"]]},
  {name: "led_drv[2].pwm", pads: [["LU2", "9"], ["LU6", "2"]]},
  {name: "led_drv[2].leda", pads: [["LL6", "2"], ["LC31", "1"]]},
  {name: "led_drv[2].ledk", pads: [["LU6", "1"], ["LR15", "2"]]},
  {name: "led_drv[2].ic.sw", pads: [["LU6", "5"], ["LC29", "2"], ["LL6", "1"]]},
  {name: "led_drv[2].ic.boot", pads: [["LU6", "6"], ["LC29", "1"]]},
  {name: "led_drv[3].pwm", pads: [["LU2", "10"], ["LU7", "2"]]},
  {name: "led_drv[3].leda", pads: [["LL7", "2"], ["LC35", "1"]]},
  {name: "led_drv[3].ledk", pads: [["LU7", "1"], ["LR16", "2"]]},
  {name: "led_drv[3].ic.sw", pads: [["LU7", "5"], ["LC33", "2"], ["LL7", "1"]]},
  {name: "led_drv[3].ic.boot", pads: [["LU7", "6"], ["LC33", "1"]]}
])

    ...
    def refinements(self) -> Refinements:
        return super().refinements() + Refinements(
            ...
            instance_values=[
                ...
                (["nfc", "cvdd1", "cap", "filter_footprints"], ["Capacitor_SMD:C_0805_2012Metric"]),
                (["nfc", "cvdd2", "cap", "filter_footprints"], ["Capacitor_SMD:C_0805_2012Metric"]),
                (["nfc", "ctvdd1", "cap", "filter_footprints"], ["Capacitor_SMD:C_0805_2012Metric"]),
                (["nfc", "ctvdd2", "cap", "filter_footprints"], ["Capacitor_SMD:C_0805_2012Metric"]),

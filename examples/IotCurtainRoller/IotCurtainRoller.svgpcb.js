...
const RC4 = board.add(C_0805_2012Metric, {
...
const RTP3 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(0.567, 2.115), rotate: 0,
  id: 'RTP3'
})
// prot_3v3.diode
const RD1 = board.add(D_SOD_323, {
  translate: pt(0.815, 2.115), rotate: 0,
  id: 'RD1'
})
// mcu.ic
...
// mcu.vcc_cap1.cap
const RC6 = board.add(C_0603_1608Metric, {
...
const RR5 = board.add(R_0603_1608Metric, {
  translate: pt(2.056, 1.868), rotate: 0,
  id: 'RR5'
})
...
const RR7 = board.add(R_0603_1608Metric, {
  translate: pt(2.291, 1.867), rotate: 0,
  id: 'RR7'
})
// enca.ic
const RU3 = board.add(SOT_23, {
  translate: pt(1.619, 1.189), rotate: 0,
  id: 'RU3'
})
// enca.cin.cap
const RC8 = board.add(C_0603_1608Metric, {
  translate: pt(1.602, 1.324), rotate: 0,
  id: 'RC8'
})
// encb.ic
const RU4 = board.add(SOT_23, {
  translate: pt(1.888, 1.189), rotate: 0,
  id: 'RU4'
})
// encb.cin.cap
const RC9 = board.add(C_0603_1608Metric, {
  translate: pt(1.871, 1.324), rotate: 0,
  id: 'RC9'
})
...
// drv.vm_cap1.cap
const RC13 = board.add(CP_Elec_8x10, {
...
board.setNetlist([
  ...
  {name: "Rgnd", pads: [["RJ1", "1"], ["RJ2", "1"], ["RTP1", "1"], ["RU1", "1"], ["RD1", "2"], ["RU2", "9"], ["RU2", "19"], ["RU3", "2"], ["RU4", "2"], ["RU5", "2"], ["RU5", "3"], ["RSW1", "2"], ["RJ4", "1"], ["RU6", "1"], ["RU6", "9"], ["RR7", "2"], ["RC11", "2"], ["RC1", "2"], ["RC5", "2"], ["RC6", "2"], ["RJ3", "5"], ["RC8", "2"], ["RC9", "2"], ["RC10", "2"], ["RC12", "2"], ["RC13", "2"], ["RR2", "2"], ["RC7", "2"], ["RR11", "1"], ["RC3", "2"], ["RC4", "2"]]},
  {name: "Rvin", pads: [["RFB1", "2"], ["RTP2", "1"], ["RU1", "3"], ["RU6", "5"], ["RR6", "1"], ["RR3", "1"], ["RC1", "1"], ["RC12", "1"], ["RC13", "1"], ["RC3", "1"]]},
  {name: "Rv3v3", pads: [["RU6", "4"], ["RTP3", "1"], ["RD1", "1"], ["RU2", "1"], ["RD2", "2"], ["RU3", "1"], ["RU4", "1"], ["RU5", "1"], ["RJ4", "2"], ["RR1", "1"], ["RU2", "7"], ["RU2", "16"], ["RR10", "1"], ["RC5", "1"], ["RC6", "1"], ["RJ3", "1"], ["RC8", "1"], ["RC9", "1"], ["RR8", "1"], ["RR9", "1"], ["RC10", "1"], ["RR4", "1"], ["RL1", "2"], ["RC4", "1"]]},
  ...
  {name: "Rmcu.program_en_node", pads: [["RU2", "2"], ["RJ3", "6"], ["RR4", "2"], ["RC7", "1"]]},
  {name: "Rledr.res.a", pads: [["RR5", "1"], ["RD2", "1"]]},
  {name: "Rals.dvi_res.b", pads: [["RR10", "2"], ["RU5", "5"], ["RC11", "1"]]},
  {name: "Rdrv.ic.isen", pads: [["RU6", "7"], ["RR11", "2"]]}
])

const limit0 = pt(-0.07874015748031496, -0.07874015748031496);
const limit1 = pt(2.7017716535433074, 2.2708661417322835);

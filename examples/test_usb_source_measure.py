    ...
    def refinements(self) -> Refinements:
        return super().refinements() + Refinements(
            ...
            instance_values=[
                ...
                (["control", "driver", "high_fet", "part_footprint"], "Package_TO_SOT_THT:TO-220-3_Horizontal_TabUp"),
                (["control", "driver", "high_fet", "part"], "IRF540N"),
                (["control", "driver", "low_fet", "part_footprint"], "Package_TO_SOT_THT:TO-220-3_Horizontal_TabUp"),

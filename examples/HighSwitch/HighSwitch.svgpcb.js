  {name: "pwr.ic.vbst", pads: [["U1", "6"], ["C2", "1"]]},
  ...
  {name: "mcu.swd_node.swdio", pads: [["J2", "2"], ["U2", "33"], ["R3", "2"]]},
  {name: "mcu.swd_node.swclk", pads: [["J2", "4"], ["U2", "29"], ["R4", "2"]]},
  {name: "mcu.reset_node", pads: [["J2", "10"], ["U2", "34"]]},
  {name: "mcu.swd.tdi", pads: [["J2", "8"]]},
  {name: "mcu.swd.swo", pads: [["J2", "6"], ["U2", "9"]]},
  ...
  {name: "can.conn.gnd", pads: [["J3", "3"], ["U3", "2"], ["C19", "2"], ["C20", "2"], ["U4", "3"], ["U5", "5"], ["C22", "2"]]},
  {name: "can.can_fuse.pwr_out", pads: [["F1", "2"], ["U3", "1"], ["U3", "3"], ["C19", "1"]]},
  {name: "can.reg.pwr_out", pads: [["U3", "5"], ["C20", "1"], ["U5", "8"], ["C22", "1"]]},
  {name: "vsense.output", pads: [["U2", "21"], ["R5", "2"], ["R6", "1"]]},
  {name: "rgb1.package.k_red", pads: [["D1", "3"], ["R7", "1"]]},
  {name: "rgb1.package.k_green", pads: [["D1", "4"], ["R8", "1"]]},
  {name: "rgb1.package.k_blue", pads: [["D1", "1"], ["R9", "1"]]},
  {name: "rgb2.package.k_red", pads: [["D2", "3"], ["R10", "1"]]},
  {name: "rgb2.package.k_green", pads: [["D2", "4"], ["R11", "1"]]},
  {name: "rgb2.package.k_blue", pads: [["D2", "1"], ["R12", "1"]]},
  {name: "light[0].control[0]", pads: [["U2", "12"], ["Q1", "1"]]},
  {name: "light[0].control[1]", pads: [["U2", "8"], ["Q3", "1"]]},
  {name: "light[0].conn.out[0]", pads: [["J4", "2"], ["Q2", "2"]]},
  {name: "light[0].conn.out[1]", pads: [["J4", "3"], ["Q4", "2"]]},
  ...
  {name: "light[1].conn.out[0]", pads: [["J5", "2"], ["Q6", "2"]]},
  {name: "light[1].conn.out[1]", pads: [["J5", "3"], ["Q8", "2"]]},
  ...
  {name: "light[2].conn.out[0]", pads: [["J6", "2"], ["Q10", "2"]]},
  {name: "light[2].conn.out[1]", pads: [["J6", "3"], ["Q12", "2"]]},
  ...
  {name: "light[3].conn.out[0]", pads: [["J7", "2"], ["Q14", "2"]]},
  {name: "light[3].conn.out[1]", pads: [["J7", "3"], ["Q16", "2"]]},
  ...
  {name: "light[4].conn.out[0]", pads: [["J8", "2"], ["Q18", "2"]]},
  {name: "light[4].conn.out[1]", pads: [["J8", "3"], ["Q20", "2"]]},
  ...
  {name: "light[5].conn.out[0]", pads: [["J9", "2"], ["Q22", "2"]]},
  {name: "light[5].conn.out[1]", pads: [["J9", "3"], ["Q24", "2"]]},

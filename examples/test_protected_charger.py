...
class ProtectedCharger(JlcBoardTop):
    ...
    def contents(self) -> None:
        ...
        with self.implicit_connect(
            ...
            (self.charger,), _ = self.chain(self.vusb, imp.Block(Mcp73831(200 * mAmp(tol=0.2))), self.pmos.chg_in)
        ...
        self.connect(
            self.pmos_load.pwr_out, self.pwr_pins.pins.request("2").adapt_to(VoltageSink(current_draw=(0, 2.0) * Amp))
        )

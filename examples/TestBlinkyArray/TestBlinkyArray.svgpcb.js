...
const led_led_0__package = board.add(LED_0603_1608Metric, {
  translate: pt(2.599, 0.595), rotate: 0,
  id: 'led_led_0__package'
})
const led_led_0__res = board.add(R_0603_1608Metric, {
  translate: pt(2.598, 0.790), rotate: 0,
  id: 'led_led_0__res'
})
const led_led_1__package = board.add(LED_0603_1608Metric, {
  translate: pt(2.755, 0.595), rotate: 0,
  id: 'led_led_1__package'
})
const led_led_1__res = board.add(R_0603_1608Metric, {
  translate: pt(2.754, 0.790), rotate: 0,
  id: 'led_led_1__res'
})
const led_led_2__package = board.add(LED_0603_1608Metric, {
  translate: pt(2.599, 0.693), rotate: 0,
  id: 'led_led_2__package'
})
const led_led_2__res = board.add(R_0603_1608Metric, {
  translate: pt(2.598, 0.887), rotate: 0,
  id: 'led_led_2__res'
})
const led_led_3__package = board.add(LED_0603_1608Metric, {
  translate: pt(2.755, 0.693), rotate: 0,
  id: 'led_led_3__package'
})
const led_led_3__res = board.add(R_0603_1608Metric, {
  translate: pt(2.754, 0.887), rotate: 0,
  id: 'led_led_3__res'
})

...
// pwr_3v3.ic
const U5 = board.add(SOT_223_3_TabPin2, {
  translate: pt(2.388, 1.844), rotate: 0,
  id: 'U5'
})
// pwr_3v3.in_cap.cap
const C7 = board.add(C_0603_1608Metric, {
  translate: pt(2.446, 2.054), rotate: 0,
  id: 'C7'
})
// pwr_3v3.out_cap.cap
const C8 = board.add(C_0805_2012Metric, {
  translate: pt(2.282, 2.064), rotate: 0,
  id: 'C8'
})
// mcu.ic
const U6 = board.add(LQFP_64_10x10mm_P0_5mm, {
...
// can.transceiver.ic
const U9 = board.add(SOP_8_6_62x9_15mm_P2_54mm, {
...
// rtc.ic
const U11 = board.add(SOIC_16W_7_5x10_3mm_P1_27mm, {
...
const U12 = board.add(PinHeader_1x06_P2_54mm_Vertical, {
  translate: pt(3.476, 1.410), rotate: 0,
  id: 'U12'
})
// rgb1.package
const D6 = board.add(LED_LiteOn_LTST_C19HE1WT, {
  translate: pt(3.448, 1.758), rotate: 0,
  id: 'D6'
})
// rgb1.red_res
const R15 = board.add(R_0603_1608Metric, {
  translate: pt(3.587, 1.731), rotate: 0,
  id: 'R15'
})
// rgb1.green_res
const R16 = board.add(R_0603_1608Metric, {
  translate: pt(3.465, 1.881), rotate: 0,
  id: 'R16'
})
// rgb1.blue_res
const R17 = board.add(R_0603_1608Metric, {
  translate: pt(3.621, 1.881), rotate: 0,
  id: 'R17'
})
// rgb2.package
...
board.setNetlist([
  {name: "gnd", pads: [["J1", "1"], ["J1", "3"], ["J2", "A1"], ["J2", "A12"], ["J2", "B1"], ["J2", "B12"], ["J2", "S1"], ["U1", "3"], ["R1", "1"], ["R2", "1"], ["U2", "2"], ["U3", "1"], ["R4", "2"], ["C1", "2"], ["C3", "2"], ["C4", "2"], ["R7", "2"], ["U4", "2"], ["C5", "2"], ["C6", "2"], ["U5", "1"], ["C7", "2"], ["C8", "2"], ["U6", "14"], ["U6", "21"], ["U6", "26"], ["U6", "27"], ["U6", "55"], ["U6", "56"], ["R9", "1"], ["C9", "2"], ["C10", "2"], ["C11", "2"], ["C12", "2"], ["C13", "2"], ["C14", "2"], ["C15", "2"], ["C16", "2"], ["C17", "2"], ["C18", "2"], ["C19", "2"], ["C20", "2"], ["X1", "2"], ["X1", "4"], ["C21", "2"], ["C22", "2"], ["J3", "3"], ["J3", "5"], ["J3", "9"], ["U9", "4"], ["C25", "2"], ["J5", "3"], ["J5", "6"], ["J5", "SH"], ["U10", "10"], ["U10", "14"], ["C27", "2"], ["C28", "2"], ["R11", "2"], ["U11", "5"], ["U11", "8"], ["C29", "2"], ["C30", "2"], ["C31", "2"], ["C32", "2"], ["J6", "17"], ["J6", "8"], ["C33", "2"], ["C34", "2"], ["C35", "2"], ["C36", "2"], ["C37", "2"], ["C38", "2"], ["C39", "2"], ["R13", "2"], ["C40", "2"], ["D5", "1"], ["C42", "2"], ["C43", "2"], ["R14", "1"], ["U12", "3"], ["SW1", "2"], ["SW2", "2"], ["R27", "2"], ["R29", "2"], ["R31", "2"]]},
  {name: "vin", pads: [["J1", "2"], ["U3", "3"], ["U3", "5"], ["C1", "1"], ["C3", "1"], ["R26", "1"]]},
  {name: "v5", pads: [["J2", "A4"], ["J2", "A9"], ["J2", "B4"], ["J2", "B9"], ["R3", "1"], ["L1", "2"], ["C4", "1"], ["R5", "1"], ["D1", "1"], ["R6", "1"], ["U4", "5"], ["U4", "6"], ["C5", "1"], ["U5", "3"], ["C7", "1"], ["R28", "1"]]},
  {name: "v3v3", pads: [["U5", "2"], ["C8", "1"], ["U6", "13"], ["U6", "18"], ["U6", "20"], ["U6", "22"], ["U6", "37"], ["U6", "41"], ["U6", "52"], ["U6", "57"], ["R8", "1"], ["C9", "1"], ["C10", "1"], ["C11", "1"], ["C12", "1"], ["C13", "1"], ["C14", "1"], ["C15", "1"], ["C16", "1"], ["C17", "1"], ["C18", "1"], ["C19", "1"], ["C20", "1"], ["J3", "1"], ["U9", "1"], ["C25", "1"], ["J5", "4"], ["R10", "1"], ["U10", "1"], ["C27", "1"], ["C28", "1"], ["R12", "1"], ["J6", "15"], ["J6", "16"], ["C33", "1"], ["L2", "1"], ["C40", "1"], ["U12", "2"], ["D6", "2"], ["D7", "2"], ["D8", "2"], ["R24", "1"], ["R25", "1"]]},
  {name: "usb_conn.usb.dp", pads: [["J2", "A6"], ["J2", "B6"], ["U1", "2"], ["U6", "47"]]},
  {name: "usb_conn.usb.dm", pads: [["J2", "A7"], ["J2", "B7"], ["U1", "1"], ["U6", "48"]]},
  {name: "usb_conn.conn.cc.cc1", pads: [["J2", "A5"], ["R1", "2"]]},
  {name: "usb_conn.conn.cc.cc2", pads: [["J2", "B5"], ["R2", "2"]]},
  {name: "bat.pwr", pads: [["U2", "1"], ["U11", "15"], ["C31", "1"]]},
  {name: "pwr_5v.ic.sw", pads: [["U3", "2"], ["C2", "2"], ["L1", "1"]]},
  {name: "pwr_5v.ic.fb", pads: [["U3", "4"], ["R3", "2"], ["R4", "1"]]},
  {name: "pwr_5v.ic.vbst", pads: [["U3", "6"], ["C2", "1"]]},
  {name: "buffer.sc_out", pads: [["Q1", "2"], ["D1", "2"], ["C6", "1"], ["R30", "1"]]},
  {name: "buffer.sense.b", pads: [["R5", "2"], ["Q1", "3"], ["U4", "4"]]},
  {name: "buffer.fet.gate", pads: [["Q1", "1"], ["U4", "1"]]},
  {name: "buffer.set.output", pads: [["R6", "2"], ["R7", "1"], ["U4", "3"]]},
  {name: "mcu.gpio.rgb1_red", pads: [["U6", "31"], ["R15", "2"]]},
  {name: "mcu.gpio.rgb1_green", pads: [["U6", "32"], ["R16", "2"]]},
  {name: "mcu.gpio.rgb1_blue", pads: [["U6", "30"], ["R17", "2"]]},
  {name: "mcu.gpio.rgb2_red", pads: [["U6", "28"], ["R18", "2"]]},
  {name: "mcu.gpio.rgb2_green", pads: [["U6", "29"], ["R19", "2"]]},
  {name: "mcu.gpio.rgb2_blue", pads: [["U6", "25"], ["R20", "2"]]},
  {name: "mcu.gpio.rgb3_red", pads: [["U6", "46"], ["R21", "2"]]},
  {name: "mcu.gpio.rgb3_green", pads: [["U6", "39"], ["R22", "2"]]},
  {name: "mcu.gpio.rgb3_blue", pads: [["U6", "34"], ["R23", "2"]]},
  {name: "mcu.xtal_node.xi", pads: [["U6", "36"], ["X1", "1"], ["C21", "1"]]},
  {name: "mcu.xtal_node.xo", pads: [["U6", "35"], ["X1", "3"], ["C22", "1"]]},
  {name: "mcu.swd_node.swdio", pads: [["U6", "44"], ["R8", "2"], ["J3", "2"]]},
  {name: "mcu.swd_node.swclk", pads: [["U6", "40"], ["R9", "2"], ["J3", "4"]]},
  {name: "mcu.reset_node", pads: [["U6", "45"], ["J3", "10"]]},
  {name: "mcu.ic.xtal_rtc.xtal_in", pads: [["U6", "42"]]},
  {name: "mcu.ic.xtal_rtc.xtal_out", pads: [["U6", "43"]]},
  {name: "mcu.swd.tdi", pads: [["J3", "8"]]},
  {name: "mcu.swd.swo", pads: [["U6", "12"], ["J3", "6"]]},
  {name: "can.controller.txd", pads: [["U6", "51"], ["U9", "3"]]},
  {name: "can.controller.rxd", pads: [["U6", "53"], ["U9", "2"]]},
  {name: "can.can.canh", pads: [["J4", "4"], ["U8", "2"], ["U9", "7"]]},
  {name: "can.can.canl", pads: [["J4", "5"], ["U8", "1"], ["U9", "6"]]},
  {name: "can.conn.pwr", pads: [["J4", "2"], ["F1", "1"]]},
  {name: "can.conn.gnd", pads: [["J4", "3"], ["U7", "2"], ["C23", "2"], ["C24", "2"], ["U8", "3"], ["U9", "5"], ["C26", "2"]]},
  {name: "can.can_fuse.pwr_out", pads: [["F1", "2"], ["U7", "1"], ["U7", "3"], ["C23", "1"]]},
  {name: "can.reg.pwr_out", pads: [["U7", "5"], ["C24", "1"], ["U9", "8"], ["C26", "1"]]},
  {name: "sd.spi.sck", pads: [["U6", "17"], ["J5", "5"]]},
  {name: "sd.spi.mosi", pads: [["U6", "15"], ["J5", "2"]]},
  {name: "sd.spi.miso", pads: [["U6", "19"], ["J5", "7"]]},
  {name: "sd.cs", pads: [["U6", "11"], ["J5", "1"]]},
  {name: "sd.cd", pads: [["U6", "16"], ["J5", "10"], ["R10", "2"]]},
  {name: "sd.wp", pads: [["J5", "11"]]},
  {name: "xbee.data.tx", pads: [["U6", "50"], ["U10", "2"]]},
  {name: "xbee.data.rx", pads: [["U6", "58"], ["U10", "3"]]},
  {name: "xbee.rssi", pads: [["U10", "6"]]},
  {name: "xbee.associate", pads: [["U10", "15"], ["D2", "2"]]},
  {name: "xbee_assoc.package.k", pads: [["D2", "1"], ["R11", "1"]]},
  {name: "rtc.spi.sck", pads: [["U6", "5"], ["U11", "1"], ["J6", "13"]]},
  {name: "rtc.spi.mosi", pads: [["U6", "6"], ["U11", "2"], ["J6", "14"]]},
  {name: "rtc.spi.miso", pads: [["U6", "7"], ["U11", "3"]]},
  {name: "rtc.cs", pads: [["U6", "64"], ["U11", "4"]]},
  {name: "rtc.clkout", pads: [["U11", "7"]]},
  {name: "rtc.int", pads: [["U11", "13"]]},
  {name: "rtc.ic.pwr", pads: [["U11", "16"], ["R12", "2"], ["C29", "1"], ["C30", "1"]]},
  {name: "rtc.ic.bbs", pads: [["U11", "14"], ["C32", "1"]]},
  {name: "eink.reset", pads: [["U6", "2"], ["J6", "10"]]},
  {name: "eink.cs", pads: [["U6", "4"], ["J6", "12"]]},
  {name: "eink.dc", pads: [["U6", "3"], ["J6", "11"]]},
  {name: "eink.busy", pads: [["U6", "1"], ["J6", "9"]]},
  ...
  {name: "ext.data.tx", pads: [["U6", "61"], ["U12", "4"]]},
  {name: "ext.data.rx", pads: [["U6", "60"], ["U12", "5"]]},
  {name: "ext.cts", pads: [["U6", "62"], ["U12", "1"]]},
  {name: "ext.rts", pads: [["U6", "59"], ["U12", "6"]]},
  {name: "rgb1.package.k_red", pads: [["D6", "3"], ["R15", "1"]]},
  {name: "rgb1.package.k_green", pads: [["D6", "4"], ["R16", "1"]]},
  {name: "rgb1.package.k_blue", pads: [["D6", "1"], ["R17", "1"]]},
  {name: "rgb2.package.k_red", pads: [["D7", "3"], ["R18", "1"]]},
  {name: "rgb2.package.k_green", pads: [["D7", "4"], ["R19", "1"]]},
  {name: "rgb2.package.k_blue", pads: [["D7", "1"], ["R20", "1"]]},
  {name: "rgb3.package.k_red", pads: [["D8", "3"], ["R21", "1"]]},
  {name: "rgb3.package.k_green", pads: [["D8", "4"], ["R22", "1"]]},
  {name: "rgb3.package.k_blue", pads: [["D8", "1"], ["R23", "1"]]},
  {name: "sw1.out", pads: [["U6", "33"], ["SW1", "1"], ["R24", "2"]]},
  {name: "sw2.out", pads: [["U6", "23"], ["SW2", "1"], ["R25", "2"]]},
  {name: "v12sense.output", pads: [["U6", "10"], ["R26", "2"], ["R27", "1"]]},
  {name: "v5sense.output", pads: [["U6", "9"], ["R28", "2"], ["R29", "1"]]},
  {name: "vscsense.output", pads: [["U6", "8"], ["R30", "2"], ["R31", "1"]]}
])

const limit0 = pt(-0.07874015748031496, -0.07874015748031496);
const limit1 = pt(3.797637795275591, 2.6814960629921263);

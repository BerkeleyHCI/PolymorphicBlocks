...
board.setNetlist([
  ...
  {name: "Dconn.pwr", pads: [["DJ1", "4"], ["DFB1", "1"]]},
  {name: "Dconn.uart.tx", pads: [["DJ1", "3"], ["DQ2", "3"]]},
  {name: "Dconn.uart.rx", pads: [["DJ1", "5"], ["DQ1", "3"]]},
  {name: "Dconn_shift.lv_uart.tx", pads: [["DQ1", "2"], ["DR1", "2"], ["DU2", "3"]]},
  {name: "Dconn_shift.lv_uart.rx", pads: [["DQ2", "2"], ["DR2", "2"], ["DU2", "4"]]},
  {name: "Dmcu.gpio.swc_0", pads: [["DU2", "5"], ["DSW1", "1"], ["DSW3", "1"], ["DSW5", "1"]]},
  {name: "Dmcu.gpio.swc_1", pads: [["DU2", "15"], ["DSW2", "1"], ["DSW4", "1"], ["DSW6", "1"]]},
  {name: "Dmcu.gpio.swr_0", pads: [["DU2", "14"], ["DD2", "1"], ["DD3", "1"]]},
  {name: "Dmcu.gpio.swr_1", pads: [["DU2", "13"], ["DD4", "1"], ["DD5", "1"]]},
  {name: "Dmcu.gpio.swr_2", pads: [["DU2", "10"], ["DD6", "1"], ["DD7", "1"]]},
  ...
  {name: "Dsw.sw[0,0].sw.com", pads: [["DSW1", "2"], ["DD2", "2"]]},
  {name: "Dsw.sw[1,0].sw.com", pads: [["DSW2", "2"], ["DD3", "2"]]},
  {name: "Dsw.sw[0,1].sw.com", pads: [["DSW3", "2"], ["DD4", "2"]]},
  {name: "Dsw.sw[1,1].sw.com", pads: [["DSW4", "2"], ["DD5", "2"]]},
  {name: "Dsw.sw[0,2].sw.com", pads: [["DSW5", "2"], ["DD6", "2"]]},
  {name: "Dsw.sw[1,2].sw.com", pads: [["DSW6", "2"], ["DD7", "2"]]},
  {name: "Dledr.package.k", pads: [["DD8", "1"], ["DR4", "1"]]},
  {name: "Doled.reset", pads: [["DU2", "16"], ["DJ3", "17"]]},
  {name: "Doled.i2c.scl", pads: [["DU2", "17"], ["DJ3", "13"], ["DR6", "2"]]},
  {name: "Doled.i2c.sda", pads: [["DU2", "18"], ["DJ3", "11"], ["DJ3", "12"], ["DR7", "2"]]},
  {name: "Doled.device.vcc", pads: [["DJ3", "3"], ["DC11", "1"]]},
  {name: "Doled.device.iref", pads: [["DJ3", "5"], ["DR5", "2"]]},
  {name: "Doled.device.vcomh", pads: [["DJ3", "4"], ["DC8", "1"]]},
  {name: "Doled.device.c1p", pads: [["DJ3", "27"], ["DC6", "1"]]},
  {name: "Doled.device.c1n", pads: [["DJ3", "26"], ["DC6", "2"]]},
  {name: "Doled.device.c2p", pads: [["DJ3", "29"], ["DC7", "1"]]},

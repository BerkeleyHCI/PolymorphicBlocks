...
const R59 = board.add(R_0603_1608Metric, {
  translate: pt(0.214, 3.238), rotate: 0,
  id: 'R59'
})
// control.ifilt.rn
const R60 = board.add(R_0603_1608Metric, {
  translate: pt(0.370, 3.238), rotate: 0,
  id: 'R60'
})
// control.ifilt.c
const C63 = board.add(C_0603_1608Metric, {
  translate: pt(0.526, 3.238), rotate: 0,
  id: 'C63'
})
// control.vmeas.ic
...
const R61 = board.add(R_0603_1608Metric, {
  translate: pt(0.682, 3.238), rotate: 0,
  id: 'R61'
})
// control.imeas.ic
...
const R62 = board.add(R_0603_1608Metric, {
  translate: pt(0.838, 3.238), rotate: 0,
  id: 'R62'
})
// control.vclamp.Q1
...
const R63 = board.add(R_0603_1608Metric, {
  translate: pt(0.994, 3.238), rotate: 0,
  id: 'R63'
})
// control.vclamp.Q2
...
const R64 = board.add(R_0603_1608Metric, {
  translate: pt(1.150, 3.238), rotate: 0,
  id: 'R64'
})
// control.snub_c.cap
const C66 = board.add(C_0603_1608Metric, {
  translate: pt(1.306, 3.238), rotate: 0,
  id: 'C66'
})
// control.iclamp.Q1
...
const R65 = board.add(R_0603_1608Metric, {
  translate: pt(1.461, 3.238), rotate: 0,
  id: 'R65'
})
// control.iclamp.Q2
...
board.setNetlist([
  ...
  {name: "v12", pads: [["R10", "1"], ["C15", "1"], ["C16", "1"], ["D3", "1"], ["J5", "2"], ["C75", "1"], ["C76", "1"]]},
  ...
  {name: "vcontrol", pads: [["R20", "1"], ["C42", "1"], ["C43", "1"], ["D7", "1"], ["TP8", "1"], ["U15", "5"], ["C54", "1"], ["U16", "5"], ["C55", "1"], ["U17", "5"], ["C60", "1"], ["U19", "5"], ["C61", "1"], ["U21", "5"], ["C62", "1"], ["U23", "8"], ["C64", "1"], ["U24", "8"], ["C65", "1"], ["U39", "8"], ["C109", "1"]]},
  ...
  {name: "filt_vusb.pwr_out", pads: [["U1", "1"], ["R1", "1"], ["FB1", "2"], ["D1", "1"]]},
  {name: "ramp.div.center", pads: [["Q1", "4"], ["C2", "2"], ["C3", "2"], ["R2", "2"], ["R3", "1"]]},
  {name: "ramp.ctl_fet.drain", pads: [["R3", "2"], ["Q2", "3"]]},
  {name: "reg_v5.fb.output", pads: [["U2", "4"], ["R4", "2"], ["R5", "1"]]},
  {name: "reg_v5.boot_cap.pos", pads: [["U2", "6"], ["C6", "1"]]},
  {name: "reg_v5.boot_cap.neg", pads: [["U2", "2"], ["C6", "2"], ["L1", "1"]]},
  {name: "reg_v5.en_res.b", pads: [["U2", "5"], ["R6", "2"]]},
  {name: "reg_3v3.fb.output", pads: [["U3", "4"], ["R7", "2"], ["R8", "1"]]},
  {name: "reg_3v3.boot_cap.pos", pads: [["U3", "6"], ["C10", "1"]]},
  {name: "reg_3v3.boot_cap.neg", pads: [["U3", "2"], ["C10", "2"], ["L2", "1"]]},
  {name: "reg_3v3.en_res.b", pads: [["U3", "5"], ["R9", "2"]]},
  {name: "reg_v12.fb.output", pads: [["U4", "3"], ["R10", "2"], ["R11", "1"], ["C16", "2"]]},
  ...
  {name: "conv.buck_sw.low_gate_res.a", pads: [["U6", "5"], ["R13", "1"]]},
  {name: "conv.buck_sw.low_gate_res.b", pads: [["Q3", "4"], ["R13", "2"]]},
  {name: "conv.buck_sw.high_gate_res.a", pads: [["U6", "8"], ["R14", "1"]]},
  {name: "conv.buck_sw.high_gate_res.b", pads: [["Q4", "4"], ["R14", "2"]]},
  {name: "conv.boost_sw.driver.ic.bst", pads: [["U7", "1"], ["C36", "1"], ["D5", "1"]]},
  {name: "conv.boost_sw.low_gate_res.a", pads: [["U7", "5"], ["R15", "1"]]},
  {name: "conv.boost_sw.low_gate_res.b", pads: [["Q5", "4"], ["R15", "2"]]},
  {name: "conv.boost_sw.high_gate_res.a", pads: [["U7", "8"], ["R16", "1"]]},
  {name: "conv.boost_sw.high_gate_res.b", pads: [["Q6", "4"], ["R16", "2"]]},
  {name: "ref_div.output", pads: [["R17", "2"], ["R18", "1"], ["U40", "3"]]},
  {name: "ref_buf.output", pads: [["R19", "1"], ["U40", "1"], ["U40", "2"]]},
  {name: "reg_vcontrol.fb.output", pads: [["U10", "3"], ["R20", "2"], ["R21", "1"], ["C43", "2"]]},
  {name: "reg_vcontrol.power_path.switch", pads: [["U10", "1"], ["L5", "2"], ["D7", "2"]]},
  {name: "filt_vcontroln.pwr_out", pads: [["FB2", "2"], ["U11", "4"], ["U11", "5"]]},
  {name: "reg_vcontroln.cf.pos", pads: [["U11", "6"], ["C44", "1"]]},
  {name: "reg_vcontroln.cf.neg", pads: [["U11", "3"], ["C44", "2"]]},
  ...
  {name: "control.int.r2.b", pads: [["C53", "2"], ["R35", "2"]]},
  ...
  {name: "control.driver.res.b", pads: [["D10", "2"], ["R48", "2"], ["U15", "1"], ["U16", "1"]]},
  ...
  {name: "control.isense.ranges[0].pwr_sw.res.a", pads: [["U18", "2"], ["R54", "1"]]},
  {name: "control.isense.ranges[1].isense.pwr_out", pads: [["R55", "2"], ["U19", "1"], ["U20", "3"]]},
  {name: "control.isense.ranges[1].pwr_sw.res.a", pads: [["U20", "2"], ["R56", "1"]]},
  {name: "control.isense.ranges[2].isense.pwr_out", pads: [["R57", "2"], ["U21", "1"], ["U22", "3"]]},
  {name: "control.isense.ranges[2].pwr_sw.res.a", pads: [["U22", "2"], ["R58", "1"]]},
  ...
  {name: "control.vmeas.rg.a", pads: [["U23", "2"], ["R61", "1"]]},
  {name: "control.vmeas.rg.b", pads: [["U23", "3"], ["R61", "2"]]},
  {name: "control.imeas.output", pads: [["U24", "7"], ["Q11", "2"]]},
  {name: "control.imeas.rg.a", pads: [["U24", "2"], ["R62", "1"]]},
  {name: "control.imeas.rg.b", pads: [["U24", "3"], ["R62", "2"]]},
  ...
  {name: "led.res.a", pads: [["D14", "1"], ["R67", "1"]]},
  {name: "i2c_pull.i2c.scl", pads: [["U1", "5"], ["U5", "5"], ["U25", "6"], ["U26", "8"], ["TP10", "1"], ["R68", "2"], ["J5", "12"], ["U29", "14"], ["U32", "1"], ["U33", "1"], ["U34", "14"], ["U37", "2"]]},
  {name: "i2c_pull.i2c.sda", pads: [["U1", "6"], ["U5", "6"], ["U25", "7"], ["U26", "7"], ["TP11", "1"], ["R69", "2"], ["J5", "10"], ["J5", "11"], ["U29", "15"], ["U32", "6"], ["U33", "6"], ["U34", "15"], ["U37", "3"]]},
  {name: "oled.reset", pads: [["J5", "16"], ["R71", "2"], ["C77", "1"]]},
  {name: "oled.device.vcomh", pads: [["J5", "3"], ["C72", "1"]]},
  {name: "oled.iref_res.a", pads: [["J5", "4"], ["R70", "1"]]},
  {name: "ioe_ctl.io.off_0", pads: [["U14", "6"], ["U29", "9"]]},
  {name: "ramp_pull.io", pads: [["Q2", "1"], ["U29", "4"], ["R72", "2"]]},
  {name: "buck_rc.input", pads: [["U26", "10"], ["R73", "1"]]},
  {name: "buck_rc.output", pads: [["U6", "2"], ["R73", "2"], ["C79", "1"]]},
  {name: "boost_rc.input", pads: [["U26", "11"], ["R74", "1"]]},
  {name: "boost_rc.output", pads: [["U7", "2"], ["R74", "2"], ["C80", "1"]]},
  ...
  {name: "conv_latch.out", pads: [["U6", "3"], ["U7", "3"], ["U29", "7"], ["U31", "6"], ["U31", "7"]]},
  {name: "conv_latch.ic.out2", pads: [["U31", "2"], ["U31", "3"]]},
  {name: "conv_en_pull.io", pads: [["U29", "6"], ["U31", "5"], ["R79", "2"]]},
  ...
  {name: "dac.out0", pads: [["R26", "1"], ["U37", "6"], ["C97", "1"]]},
  {name: "dac.out1", pads: [["R32", "1"], ["U37", "7"], ["C98", "1"]]},
  {name: "dac.out2", pads: [["R29", "1"], ["U37", "8"], ["C99", "1"]]},
  {name: "dac.out3", pads: [["R30", "1"], ["U37", "9"], ["C100", "1"]]},
  {name: "dac.rdy", pads: [["U37", "5"]]},
  {name: "dac_ferrite.pwr_out", pads: [["U37", "1"], ["U37", "4"], ["C95", "1"], ["C96", "1"], ["FB3", "2"]]},
  ...
  {name: "outp.port", pads: [["R36", "1"], ["U18", "6"], ["U20", "4"], ["U22", "4"], ["R64", "1"], ["D12", "1"], ["J14", "1"], ["J15", "2"]]},

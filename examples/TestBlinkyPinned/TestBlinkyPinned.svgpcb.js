...
const U1 = board.add(SOT_23, {
  translate: pt(1.652, 0.861), rotate: 0,
  id: 'U1'
})
// usb.cc_pull.cc1
const R1 = board.add(R_0603_1608Metric, {
  translate: pt(1.635, 0.996), rotate: 0,
  id: 'R1'
})
// usb.cc_pull.cc2
const R2 = board.add(R_0603_1608Metric, {
  translate: pt(1.635, 1.093), rotate: 0,
  id: 'R2'
})
// reg.ic
const U2 = board.add(SOT_223_3_TabPin2, {
  translate: pt(2.216, 0.142), rotate: 0,
  id: 'U2'
})
// reg.in_cap.cap
const C1 = board.add(C_0603_1608Metric, {
  translate: pt(2.321, 0.352), rotate: 0,
  id: 'C1'
})
// reg.out_cap.cap
const C2 = board.add(C_1206_3216Metric, {
  translate: pt(2.133, 0.368), rotate: 0,
  id: 'C2'
})
// mcu.ic
...
const D1 = board.add(LED_0603_1608Metric, {
  translate: pt(2.184, 0.823), rotate: 0,
  id: 'D1'
})
// led.res
const R4 = board.add(R_0603_1608Metric, {
  translate: pt(2.183, 0.920), rotate: 0,
  id: 'R4'
})
// npx_shift.ic
const U4 = board.add(SOT_23_5, {
  translate: pt(1.926, 0.861), rotate: 0,
  id: 'U4'
})
// npx_shift.vdd_cap.cap
const C17 = board.add(C_0603_1608Metric, {
  translate: pt(1.904, 0.996), rotate: 0,
  id: 'C17'
})

board.setNetlist([
  {name: "usb.pwr", pads: [["J1", "A4"], ["J1", "A9"], ["J1", "B4"], ["J1", "B9"], ["U2", "3"], ["C1", "1"], ["D3", "4"], ["C11", "1"], ["D5", "4"], ["C12", "1"], ["D7", "4"], ["C13", "1"], ["D9", "4"], ["C14", "1"], ["D11", "4"], ["C15", "1"], ["D13", "4"], ["C16", "1"], ["U4", "5"], ["C17", "1"]]},
  {name: "usb.gnd", pads: [["J1", "A1"], ["J1", "A12"], ["J1", "B1"], ["J1", "B12"], ["J1", "S1"], ["U1", "3"], ["R1", "1"], ["R2", "1"], ["U2", "1"], ["C1", "2"], ["C2", "2"], ["U3", "23"], ["U3", "35"], ["U3", "44"], ["U3", "47"], ["U3", "8"], ["C3", "2"], ["C4", "2"], ["C5", "2"], ["C6", "2"], ["C7", "2"], ["C8", "2"], ["X1", "2"], ["X1", "4"], ["C9", "2"], ["C10", "2"], ["J2", "3"], ["J2", "5"], ["J2", "9"], ["R4", "2"], ["D3", "2"], ["C11", "2"], ["D5", "2"], ["C12", "2"], ["D7", "2"], ["C13", "2"], ["D9", "2"], ["C14", "2"], ["D11", "2"], ["C15", "2"], ["D13", "2"], ["C16", "2"], ["U4", "1"], ["U4", "3"], ["C17", "2"]]},
  ...
  {name: "reg.pwr_out", pads: [["U2", "2"], ["C2", "1"], ["U3", "1"], ["U3", "24"], ["U3", "36"], ["U3", "48"], ["U3", "9"], ["C3", "1"], ["C4", "1"], ["C5", "1"], ["C6", "1"], ["C7", "1"], ["C8", "1"], ["J2", "1"], ["R3", "1"]]},
  {name: "mcu.gpio.cols_0", pads: [["U3", "16"], ["SW1", "1"], ["SW3", "1"], ["SW5", "1"]]},
  {name: "mcu.gpio.cols_1", pads: [["U3", "17"], ["SW2", "1"], ["SW4", "1"], ["SW6", "1"]]},
  {name: "mcu.gpio.rows_0", pads: [["U3", "18"], ["D2", "1"], ["D4", "1"]]},
  {name: "mcu.gpio.rows_1", pads: [["U3", "19"], ["D6", "1"], ["D8", "1"]]},
  {name: "mcu.gpio.rows_2", pads: [["U3", "20"], ["D10", "1"], ["D12", "1"]]},
  {name: "mcu.xtal_node.xi", pads: [["U3", "5"], ["X1", "1"], ["C9", "1"]]},
  {name: "mcu.xtal_node.xo", pads: [["U3", "6"], ["X1", "3"], ["C10", "1"]]},
  {name: "mcu.swd_node.swdio", pads: [["U3", "34"], ["J2", "2"]]},
  {name: "mcu.swd_node.swclk", pads: [["U3", "37"], ["J2", "4"]]},
  {name: "mcu.reset_node", pads: [["U3", "7"], ["J2", "10"]]},
  {name: "mcu.swd.tdi", pads: [["J2", "8"]]},
  {name: "mcu.swd.swo", pads: [["J2", "6"]]},
  {name: "led.signal", pads: [["U3", "10"], ["D1", "2"]]},
  {name: "led.package.k", pads: [["D1", "1"], ["R4", "1"]]},
  {name: "sw.npx_din", pads: [["D3", "3"], ["U4", "4"]]},
  ...
  {name: "npx_shift.input", pads: [["U3", "11"], ["U4", "2"]]}
])

const limit0 = pt(-0.07874015748031496, -0.07874015748031496);
const limit1 = pt(2.507086614173229, 2.1181102362204722);

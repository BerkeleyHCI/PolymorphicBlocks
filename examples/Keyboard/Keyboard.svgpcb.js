...
const U3 = board.add(SOT_23, {
  translate: pt(2.791, 2.185), rotate: 0,
  id: 'U3'
})
// ledr.package
...
board.setNetlist([
  {name: "usb_chain_0.d_P", pads: [["J1", "A6"], ["J1", "B6"], ["U2", "22"], ["U3", "2"]]},
  {name: "usb_chain_0.d_N", pads: [["J1", "A7"], ["J1", "B7"], ["U2", "21"], ["U3", "1"]]},
  ...
  {name: "mcu.gpio.0_0", pads: [["U2", "19"], ["SW1", "1"], ["SW2", "1"], ["SW3", "1"]]},
  {name: "mcu.gpio.0_1", pads: [["U2", "20"], ["SW4", "1"], ["SW5", "1"], ["SW6", "1"]]},
  {name: "mcu.gpio.0_2", pads: [["U2", "25"], ["SW7", "1"], ["SW8", "1"], ["SW9", "1"]]},
  {name: "mcu.gpio.0_3", pads: [["U2", "26"], ["SW10", "1"], ["SW11", "1"], ["SW12", "1"]]},
  {name: "mcu.gpio.1_0", pads: [["U2", "27"], ["D2", "1"], ["D8", "1"], ["D14", "1"], ["D20", "1"]]},
  {name: "mcu.gpio.1_1", pads: [["U2", "28"], ["D4", "1"], ["D10", "1"], ["D16", "1"], ["D22", "1"]]},
  {name: "mcu.gpio.1_2", pads: [["U2", "29"], ["D6", "1"], ["D12", "1"], ["D18", "1"], ["D24", "1"]]},
  ...
  {name: "sw.npx_din", pads: [["D3", "4"], ["U5", "4"], ["TP1", "1"]]},
  ...
  {name: "sw.sw[0,1].sw.com", pads: [["SW2", "2"], ["D4", "2"]]},
  {name: "sw.sw[0,2].npx_dout", pads: [["D7", "2"], ["D13", "4"]]},
  {name: "sw.sw[0,2].sw.com", pads: [["SW3", "2"], ["D6", "2"]]},
  {name: "sw.sw[1,0].npx_dout", pads: [["D9", "2"], ["D15", "4"]]},
  {name: "sw.sw[1,0].sw.com", pads: [["SW4", "2"], ["D8", "2"]]},
  ...
  {name: "sw.sw[2,0].sw.com", pads: [["SW7", "2"], ["D14", "2"]]},
  {name: "sw.sw[2,1].npx_din", pads: [["D17", "4"], ["D23", "2"]]},
  {name: "sw.sw[2,1].sw.com", pads: [["SW8", "2"], ["D16", "2"]]},
  {name: "sw.sw[2,2].npx_dout", pads: [["D19", "2"], ["D25", "4"]]},
  {name: "sw.sw[2,2].sw.com", pads: [["SW9", "2"], ["D18", "2"]]},
  {name: "sw.sw[3,0].npx_dout", pads: [["D21", "2"], ["D23", "4"]]},
  {name: "sw.sw[3,0].sw.com", pads: [["SW10", "2"], ["D20", "2"]]},
  {name: "sw.sw[3,1].sw.com", pads: [["SW11", "2"], ["D22", "2"]]},
  {name: "sw.sw[3,2].sw.com", pads: [["SW12", "2"], ["D24", "2"]]},
  ...
  {name: "npx_shift.input", pads: [["U2", "18"], ["U5", "2"]]}
])

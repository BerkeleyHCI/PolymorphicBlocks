...
board.setNetlist([
  {name: "gnd", pads: [["OU1", "5"], ["OU2", "1"], ["OR2", "2"], ["OC1", "2"], ["OC3", "2"], ["OC4", "2"], ["OD1", "2"], ["OJ1", "5"], ["OU3", "19"], ["OU3", "9"], ["OC5", "2"], ["OC6", "2"], ["OC7", "2"], ["OU4", "2"], ["OU4", "8"], ["OC8", "2"], ["OR6", "2"], ["OR7", "2"], ["OR9", "2"]]},
  {name: "vobd", pads: [["OFB1", "2"], ["OU2", "3"], ["OC1", "1"], ["OC3", "1"], ["OR3", "1"], ["OR8", "1"]]},
  {name: "v3v3", pads: [["OR1", "1"], ["OL1", "2"], ["OC4", "1"], ["OD1", "1"], ["OJ1", "1"], ["OU3", "1"], ["OU3", "16"], ["OU3", "7"], ["OC5", "1"], ["OC6", "1"], ["OR4", "1"], ["OU4", "3"], ["OC8", "1"], ["OD2", "2"]]},
  {name: "obd.pwr", pads: [["OU1", "16"], ["OFB1", "1"]]},
  {name: "obd.can.canh", pads: [["OU1", "6"], ["OU4", "7"]]},
  {name: "obd.can.canl", pads: [["OU1", "14"], ["OU4", "6"]]},
  {name: "reg_3v3.ic.sw", pads: [["OU2", "2"], ["OC2", "2"], ["OL1", "1"]]},
  {name: "reg_3v3.ic.fb", pads: [["OU2", "4"], ["OR1", "2"], ["OR2", "1"]]},
  {name: "reg_3v3.ic.boot", pads: [["OU2", "6"], ["OC2", "1"]]},
  {name: "reg_3v3.ic.en", pads: [["OU2", "5"], ["OR3", "2"]]},
  {name: "mcu.program_uart_node.a_tx", pads: [["OJ1", "4"], ["OU3", "11"]]},
  {name: "mcu.program_uart_node.b_tx", pads: [["OJ1", "3"], ["OU3", "12"]]},
  {name: "mcu.program_en_node", pads: [["OJ1", "6"], ["OU3", "2"], ["OR4", "2"], ["OC7", "1"]]},
  {name: "mcu.program_boot_node", pads: [["OJ1", "2"], ["OU3", "8"], ["OR5", "2"]]},
  {name: "can.controller.txd", pads: [["OU3", "6"], ["OU4", "1"]]},
  {name: "can.controller.rxd", pads: [["OU3", "5"], ["OU4", "4"]]},
  {name: "ledr.package.k", pads: [["OD2", "1"], ["OR5", "1"]]},
  {name: "ledg.signal", pads: [["OU3", "13"], ["OD3", "2"]]},
  {name: "ledg.package.k", pads: [["OD3", "1"], ["OR6", "1"]]},
  {name: "ledw.signal", pads: [["OU3", "14"], ["OD4", "2"]]},
  {name: "ledw.package.k", pads: [["OD4", "1"], ["OR7", "1"]]},
  {name: "vobd_sense.output", pads: [["OU3", "3"], ["OR8", "2"], ["OR9", "1"]]}
])

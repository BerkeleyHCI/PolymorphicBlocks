...
const BC4 = board.add(C_1206_3216Metric, {
...
const BTP3 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(2.051, 1.682), rotate: 0,
  id: 'BTP3'
})
// prot_3v3.diode
...
// mcu.vcc_cap0.cap
const BC6 = board.add(C_0805_2012Metric, {
...
const BD2 = board.add(LED_0603_1608Metric, {
  translate: pt(0.838, 1.674), rotate: 0,
  id: 'BD2'
})
// ledr.res
...
const BR6 = board.add(R_0603_1608Metric, {
  translate: pt(1.073, 1.674), rotate: 0,
  id: 'BR6'
})
...
const BR8 = board.add(R_0603_1608Metric, {
  translate: pt(1.307, 1.674), rotate: 0,
  id: 'BR8'
})
...
const BJ5 = board.add(JST_SH_SM04B_SRSS_TB_1x04_1MP_P1_00mm_Horizontal, {
  translate: pt(1.717, 1.251), rotate: 0,
  id: 'BJ5'
})
// drv.ic
...
board.setNetlist([
  {name: "vin_raw", pads: [["BJ1", "2"], ["BJ2", "2"], ["BF1", "1"]]},
  {name: "gnd", pads: [["BJ1", "1"], ["BJ2", "1"], ["BJ3", "4"], ["BTP1", "1"], ["BU1", "1"], ["BR2", "2"], ["BC1", "2"], ["BC3", "2"], ["BC4", "2"], ["BC5", "2"], ["BD1", "2"], ["BJ4", "5"], ["BU2", "19"], ["BU2", "9"], ["BC6", "2"], ["BC7", "2"], ["BC8", "2"], ["BR7", "2"], ["BJ5", "1"], ["BU3", "1"], ["BU3", "9"], ["BC9", "2"], ["BC10", "2"], ["BR10", "1"]]},
  {name: "vin", pads: [["BJ3", "1"], ["BFB1", "2"], ["BTP2", "1"], ["BU1", "3"], ["BC1", "1"], ["BC3", "1"], ["BC4", "1"], ["BR3", "1"], ["BR6", "1"], ["BU3", "5"], ["BC9", "1"], ["BC10", "1"]]},
  {name: "v3v3", pads: [["BR1", "1"], ["BL1", "2"], ["BC5", "1"], ["BTP3", "1"], ["BD1", "1"], ["BJ4", "1"], ["BU2", "1"], ["BU2", "16"], ["BU2", "7"], ["BC6", "1"], ["BC7", "1"], ["BR4", "1"], ["BD2", "2"], ["BR8", "1"], ["BR9", "1"], ["BJ5", "2"], ["BU3", "4"]]},
  {name: "conn.enca", pads: [["BJ3", "2"], ["BU2", "13"]]},
  {name: "conn.encb", pads: [["BJ3", "3"], ["BU2", "10"]]},
  {name: "conn.motor2", pads: [["BJ3", "5"], ["BU3", "6"]]},
  {name: "conn.motor1", pads: [["BJ3", "6"], ["BU3", "8"]]},
  {name: "fuse.pwr_out", pads: [["BF1", "2"], ["BFB1", "1"]]},
  {name: "reg_3v3.ic.sw", pads: [["BU1", "2"], ["BC2", "2"], ["BL1", "1"]]},
  {name: "reg_3v3.ic.fb", pads: [["BU1", "4"], ["BR1", "2"], ["BR2", "1"]]},
  {name: "reg_3v3.ic.boot", pads: [["BU1", "6"], ["BC2", "1"]]},
  {name: "reg_3v3.ic.en", pads: [["BU1", "5"], ["BR3", "2"]]},
  {name: "mcu.program_uart_node.a_tx", pads: [["BJ4", "4"], ["BU2", "11"]]},
  {name: "mcu.program_uart_node.b_tx", pads: [["BJ4", "3"], ["BU2", "12"]]},
  {name: "mcu.program_en_node", pads: [["BJ4", "6"], ["BU2", "2"], ["BR4", "2"], ["BC8", "1"]]},
  {name: "mcu.program_boot_node", pads: [["BJ4", "2"], ["BU2", "8"], ["BR5", "2"]]},
  {name: "ledr.package.k", pads: [["BD2", "1"], ["BR5", "1"]]},
  {name: "vin_sense.output", pads: [["BU2", "3"], ["BR6", "2"], ["BR7", "1"]]},
  {name: "qwiic_pull.i2c.scl", pads: [["BU2", "5"], ["BR8", "2"], ["BJ5", "4"]]},
  {name: "qwiic_pull.i2c.sda", pads: [["BU2", "6"], ["BR9", "2"], ["BJ5", "3"]]},
  {name: "drv.in1", pads: [["BU2", "15"], ["BU3", "3"]]},
  {name: "drv.in2", pads: [["BU2", "14"], ["BU3", "2"]]},
  {name: "drv.ic.isen", pads: [["BU3", "7"], ["BR10", "2"]]}
])

const limit0 = pt(-0.07874015748031496, -0.07874015748031496);
const limit1 = pt(2.5440944881889767, 2.1551181102362205);

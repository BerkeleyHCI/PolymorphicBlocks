...
class PcbBot(JlcBoardTop):
    ...
    def contents(self) -> None:
        ...
        with self.implicit_connect(
            ...
            self.pwr_or = self.Block(
                PriorityPowerOr((0, 1) * Volt, (0, 0.1) * Ohm)  # also does reverse protection
            ...
            (self.charger,), _ = self.chain(self.vusb, imp.Block(Mcp73831(200 * mAmp(tol=0.2))), self.batt.pwr)
        ...
        with self.implicit_connect(
            ...
            (self.i2c_pull, self.i2c_tp), self.i2c_chain = self.chain(
                self.i2c, imp.Block(I2cPullup()), imp.Block(I2cTestPoint("i2c")), self.tof.i2c
            )
        ...
        with self.implicit_connect(
            ...
            (self.npx, self.npx_key), _ = self.chain(
                self.mcu.gpio.request("npx"), imp.Block(NeopixelArray(4 * 4)), imp.Block(Neopixel())
            )

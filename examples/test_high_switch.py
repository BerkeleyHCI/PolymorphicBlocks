    ...
    def refinements(self) -> Refinements:
        return super().refinements() + Refinements(
            ...
            instance_values=[
                ...
                (
                    ["light[0]", "drv[1]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[1]", "drv[0]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[1]", "drv[1]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[2]", "drv[0]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[2]", "drv[1]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[3]", "drv[0]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[3]", "drv[1]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[4]", "drv[0]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[4]", "drv[1]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[5]", "drv[0]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
                (
                    ["light[5]", "drv[1]", "drv", "footprint_spec"],
                    ParamValue(["light[0]", "drv[0]", "drv", "footprint_spec"]),
                ),
            ],

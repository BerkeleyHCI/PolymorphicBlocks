...
board.setNetlist([
  ...
  {name: "Rreg_3v3.boot_cap.neg", pads: [["RU1", "2"], ["RC2", "2"], ["RL1", "1"]]},
  {name: "Rreg_3v3.boot_cap.pos", pads: [["RU1", "6"], ["RC2", "1"]]},
  {name: "Rreg_3v3.en_res.b", pads: [["RU1", "5"], ["RR3", "2"]]},
  ...
  {name: "Rledr.res.a", pads: [["RD2", "1"], ["RR5", "1"]]},
  {name: "Rvin_sense.output", pads: [["RU2", "17"], ["RR6", "2"], ["RR7", "1"]]},
  {name: "Renca.out", pads: [["RU2", "13"], ["RU3", "2"]]},
  {name: "Rencb.out", pads: [["RU2", "10"], ["RU4", "2"]]},
  {name: "Rals.dvi_res.b", pads: [["RU5", "5"], ["RR10", "2"], ["RC12", "1"]]},
  {name: "Rsw.out", pads: [["RU2", "3"], ["RSW1", "1"]]},
  {name: "Rdrv.in1", pads: [["RU2", "14"], ["RU6", "3"]]},
  {name: "Rdrv.in2", pads: [["RU2", "15"], ["RU6", "2"]]},
  {name: "Rdrv.out1", pads: [["RJ5", "1"], ["RU6", "6"]]},
  {name: "Rdrv.out2", pads: [["RJ5", "2"], ["RU6", "8"]]},

...
def run_test_board(design: Type[Block]) -> None:
    ...
    with open(os.path.join(os.path.dirname(designfile), design.__name__ + ".net"), newline=None) as f:
        generated_netlist = f.read()

    with open(os.path.join(os.path.dirname(designfile), design.__name__ + ".net.ref"), newline=None) as f:

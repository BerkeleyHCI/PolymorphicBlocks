...
board.setNetlist([
  ...
  {name: "Kals.ic.dvi", pads: [["KU4", "5"], ["KR8", "2"], ["KC7", "1"]]},
  {name: "Kdist.ic.gpio1", pads: [["KU5", "7"]]},
  {name: "Koled.reset", pads: [["KU2", "8"], ["KJ3", "14"]]},
  {name: "Koled.device.vcc", pads: [["KJ3", "28"], ["KC16", "1"]]},
  {name: "Koled.device.iref", pads: [["KJ3", "26"], ["KR9", "2"]]},
  {name: "Koled.device.vcomh", pads: [["KJ3", "27"], ["KC13", "1"]]},
  {name: "Koled.device.c1p", pads: [["KJ3", "4"], ["KC11", "1"]]},
  {name: "Koled.device.c1n", pads: [["KJ3", "5"], ["KC11", "2"]]},
  {name: "Koled.device.c2p", pads: [["KJ3", "2"], ["KC12", "1"]]},
  {name: "Koled.device.c2n", pads: [["KJ3", "3"], ["KC12", "2"]]},
  {name: "Krgb_shift.input", pads: [["KU2", "10"], ["KU8", "2"], ["KR10", "2"]]},
  {name: "Krgb_shift.output", pads: [["KU8", "4"], ["KTP6", "1"], ["KD4", "1"]]},
  ...
  {name: "Kspk_dac.output", pads: [["KR11", "2"], ["KC52", "1"], ["KTP7", "1"], ["KC55", "2"]]},
  {name: "Kspk_drv.spk.a", pads: [["KU9", "5"], ["KJ4", "1"]]},
  {name: "Kspk_drv.spk.b", pads: [["KU9", "8"], ["KJ4", "2"]]},
  {name: "Kspk_drv.ic.inp", pads: [["KU9", "3"], ["KC55", "1"]]},
  {name: "Kspk_drv.ic.inn", pads: [["KU9", "4"], ["KC56", "1"]]},

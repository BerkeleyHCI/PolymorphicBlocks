...
board.setNetlist([
  ...
  {name: "gate.btn_out", pads: [["D2", "2"], ["U3", "32"]]},
  {name: "gate.control", pads: [["R4", "2"], ["Q2", "1"], ["U3", "33"]]},
  {name: "gate.pwr_gate.btn_in", pads: [["D1", "1"], ["D2", "1"], ["SW1", "1"]]},
  {name: "gate.pwr_gate.pull_res.b", pads: [["R3", "2"], ["Q1", "1"], ["Q2", "3"], ["D1", "2"]]},
  {name: "charger.prog_res.a", pads: [["U2", "5"], ["R6", "1"]]},
  {name: "charge_led.signal", pads: [["U2", "1"], ["R7", "2"]]},
  {name: "charge_led.res.a", pads: [["D6", "1"], ["R7", "1"]]},
  ...
  {name: "mag.set_cap.pos", pads: [["U6", "8"], ["C11", "1"]]},
  {name: "mag.set_cap.neg", pads: [["U6", "12"], ["C11", "2"]]},
  {name: "mag.c1.pos", pads: [["U6", "10"], ["C12", "1"]]},
  ...
  {name: "rgb.red_res.a", pads: [["D8", "1"], ["R12", "1"]]},
  {name: "rgb.green_res.a", pads: [["D8", "3"], ["R13", "1"]]},
  {name: "rgb.blue_res.a", pads: [["D8", "4"], ["R14", "1"]]},
  {name: "oled.reset", pads: [["U3", "31"], ["J8", "14"]]},
  {name: "oled.device.vcc", pads: [["J8", "28"], ["C19", "1"]]},
  {name: "oled.device.vcomh", pads: [["J8", "27"], ["C16", "1"]]},
  {name: "oled.c1_cap.pos", pads: [["J8", "4"], ["C14", "1"]]},
  {name: "oled.c1_cap.neg", pads: [["J8", "5"], ["C14", "2"]]},
  {name: "oled.c2_cap.pos", pads: [["J8", "2"], ["C15", "1"]]},
  {name: "oled.c2_cap.neg", pads: [["J8", "3"], ["C15", "2"]]},
  {name: "oled.iref_res.a", pads: [["J8", "26"], ["R15", "1"]]},
  ...
  {name: "cam.reset_cap.pos", pads: [["J13", "19"], ["C26", "1"], ["R18", "2"]]},

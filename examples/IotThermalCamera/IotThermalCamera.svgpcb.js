...
const TH1 = board.add(JlcToolingHole_1_152mm, {
  translate: pt(2.313, 3.103), rotate: 0,
  id: 'TH1'
})
// jlc_th.th2
const TH2 = board.add(JlcToolingHole_1_152mm, {
  translate: pt(2.352, 3.103), rotate: 0,
  id: 'TH2'
})
// jlc_th.th3
const TH3 = board.add(JlcToolingHole_1_152mm, {
  translate: pt(2.313, 3.143), rotate: 0,
  id: 'TH3'
})
// usb.conn
const TJ1 = board.add(USB_C_Receptacle_XKB_U262_16XN_4BVC11, {
  translate: pt(2.167, 1.905), rotate: 0,
  id: 'TJ1'
})
// usb.esd
const TU1 = board.add(SOT_23, {
  translate: pt(2.033, 2.198), rotate: 0,
  id: 'TU1'
})
// eth.conn
...
const TU2 = board.add(HSOP_8_1EP_3_9x4_9mm_P1_27mm_EP2_41x3_1mm_ThermalVias, {
  translate: pt(3.316, 1.846), rotate: 0,
  id: 'TU2'
})
// poe.cls.res
const TR3 = board.add(R_0603_1608Metric, {
  translate: pt(3.228, 2.198), rotate: 0,
  id: 'TR3'
})
// poe.den
const TR4 = board.add(R_0603_1608Metric, {
  translate: pt(3.384, 2.198), rotate: 0,
  id: 'TR4'
})
// poe.vdd_cap.cap
const TC2 = board.add(C_0805_2012Metric, {
  translate: pt(3.552, 2.031), rotate: 0,
  id: 'TC2'
})
// poe.prot.diode
const TD1 = board.add(D_SMA, {
  translate: pt(3.308, 2.061), rotate: 0,
  id: 'TD1'
})
// poe_jmp.pos
const TJP1 = board.add(SolderJumper_2_P1_3mm_Open_TrianglePad1_0x1_5mm, {
  translate: pt(2.501, 2.604), rotate: 0,
  id: 'TJP1'
})
// poe_jmp.neg
const TJP2 = board.add(SolderJumper_2_P1_3mm_Open_TrianglePad1_0x1_5mm, {
  translate: pt(2.501, 2.741), rotate: 0,
  id: 'TJP2'
})
// tp_gnd.tp
const TTP1 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(1.143, 3.141), rotate: 0,
  id: 'TTP1'
})
// tp_poe.tp
const TTP2 = board.add(TestPoint_TE_RCT_0805, {
  translate: pt(1.393, 3.141), rotate: 0,
  id: 'TTP2'
})
// reg_poe.ic
const TU3 = board.add(HSOP_8_1EP_3_9x4_9mm_P1_27mm_EP2_41x3_1mm_ThermalVias, {
...
// mcu.ic
const TU8 = board.add(ESP32_S3_WROOM_1, {
...
const TD4 = board.add(LED_0603_1608Metric, {
  translate: pt(4.165, 2.583), rotate: 0,
  id: 'TD4'
})
// ledr.res
const TR12 = board.add(R_0603_1608Metric, {
  translate: pt(4.165, 2.680), rotate: 0,
  id: 'TR12'
})
// phy.ic
const TU9 = board.add(LQFP_48_7x7mm_P0_5mm, {
...
board.setNetlist([
  {name: "gnd", pads: [["TJ1", "A1"], ["TJ1", "A12"], ["TJ1", "B1"], ["TJ1", "B12"], ["TJ1", "S1"], ["TU1", "3"], ["TC1", "2"], ["TU2", "5"], ["TU2", "8"], ["TTP1", "1"], ["TU3", "1"], ["TU3", "9"], ["TR6", "2"], ["TC3", "2"], ["TR7", "1"], ["TC5", "2"], ["TC6", "2"], ["TC7", "2"], ["TD2", "2"], ["TU4", "1"], ["TR9", "2"], ["TC8", "2"], ["TC10", "2"], ["TC11", "2"], ["TD3", "2"], ["TU5", "2"], ["TC12", "2"], ["TC13", "2"], ["TU6", "2"], ["TC14", "2
  {name: "v1v2", pads: [["TU7", "5"], ["TC17", "1"], ["TJ5", "10"], ["TU13", "7"], ["TC47", "1"]]},
  {name: "i2c_chain_0.scl", pads: [["TU8", "33"], ["TR23", "2"], ["TTP5", "1"], ["TU10", "C4"], ["TU11", "6"], ["TU12", "12"], ["TJ5", "5"], ["TU13", "21"]]},
  {name: "i2c_chain_0.sda", pads: [["TU8", "32"], ["TR24", "2"], ["TTP6", "1"], ["TU10", "C3"], ["TU11", "7"], ["TU12", "11"], ["TJ5", "3"], ["TU13", "22"]]},
  {name: "usb.pwr", pads: [["TJ1", "A4"], ["TJ1", "A9"], ["TJ1", "B4"], ["TJ1", "B9"], ["TR5", "1"], ["TL1", "2"], ["TC7", "1"], ["TD2", "1"], ["TFB1", "1"], ["TU11", "2"]]},
  {name: "usb.usb.dp", pads: [["TJ1", "A6"], ["TJ1", "B6"], ["TU1", "2"], ["TU8", "14"]]},
  {name: "usb.usb.dm", pads: [["TJ1", "A7"], ["TJ1", "B7"], ["TU1", "1"], ["TU8", "13"]]},
  {name: "usb.cc.cc1", pads: [["TJ1", "A5"], ["TU11", "10"], ["TU11", "11"]]},
  {name: "usb.cc.cc2", pads: [["TJ1", "B5"], ["TU11", "1"], ["TU11", "14"]]},
  {name: "eth.eth.tx.pos", pads: [["TJ2", "5"], ["TR14", "2"], ["TR18", "2"]]},
  {name: "eth.eth.tx.neg", pads: [["TJ2", "6"], ["TR15", "2"], ["TR19", "2"]]},
  {name: "eth.eth.tx.center", pads: [["TJ2", "4"], ["TR20", "2"], ["TC34", "1"]]},
  {name: "eth.eth.rx.pos", pads: [["TJ2", "1"], ["TC35", "1"]]},
  {name: "eth.eth.rx.neg", pads: [["TJ2", "2"], ["TC36", "1"]]},
  {name: "eth.eth.rx.center", pads: [["TJ2", "3"], ["TR21", "2"], ["TR22", "2"], ["TC37", "1"]]},
  {name: "eth.poe.pos", pads: [["TJ2", "9"], ["TJP1", "1"]]},
  {name: "eth.poe.neg", pads: [["TJ2", "10"], ["TJP2", "1"]]},
  {name: "eth.led_yel_sink", pads: [["TR1", "2"], ["TU12", "10"]]},
  {name: "eth.led_grn_sink", pads: [["TR2", "2"], ["TU12", "8"]]},
  {name: "eth.conn.led_grn_cathode", pads: [["TJ2", "14"], ["TR2", "1"]]},
  {name: "eth.conn.led_yel_cathode", pads: [["TJ2", "12"], ["TR1", "1"]]},
  {name: "eth.conn.shield", pads: [["TJ2", "SH"], ["TC1", "1"]]},
  {name: "poe.pwr_out", pads: [["TU2", "1"], ["TR4", "1"], ["TC2", "1"], ["TD1", "1"], ["TJP1", "2"], ["TTP2", "1"], ["TU3", "2"], ["TU3", "3"], ["TC3", "1"], ["TC5", "1"], ["TC6", "1"]]},
  {name: "poe.poe.neg", pads: [["TU2", "4"], ["TU2", "9"], ["TR3", "1"], ["TC2", "2"], ["TD1", "2"], ["TJP2", "2"]]},
  {name: "poe.cdb", pads: [["TU2", "6"]]},
  {name: "poe.t2p", pads: [["TU2", "7"]]},
  {name: "poe.ic.den", pads: [["TU2", "2"], ["TR4", "2"]]},
  {name: "poe.ic.cls", pads: [["TU2", "3"], ["TR3", "2"]]},
  {name: "reg_poe.pg", pads: [["TU3", "6"]]},
  {name: "reg_poe.ic.sw", pads: [["TU3", "8"], ["TC4", "2"], ["TL1", "1"]]},
  {name: "reg_poe.ic.fb", pads: [["TU3", "5"], ["TR5", "2"], ["TR6", "1"]]},
  {name: "reg_poe.ic.boot", pads: [["TU3", "7"], ["TC4", "1"]]},
  {name: "reg_poe.ic.rt", pads: [["TU3", "4"], ["TR7", "2"]]},
  {name: "reg_3v3.ic.sw", pads: [["TU4", "2"], ["TC9", "2"], ["TL2", "1"]]},
  {name: "reg_3v3.ic.fb", pads: [["TU4", "4"], ["TR8", "2"], ["TR9", "1"]]},
  {name: "reg_3v3.ic.boot", pads: [["TU4", "6"], ["TC9", "1"]]},
  {name: "reg_3v3.ic.en", pads: [["TU4", "5"], ["TR10", "2"]]},
  {name: "mcu.program_uart_node.a_tx", pads: [["TJ3", "4"], ["TU8", "36"]]},
  {name: "mcu.program_uart_node.b_tx", pads: [["TJ3", "3"], ["TU8", "37"]]},
  {name: "mcu.program_en_node", pads: [["TJ3", "6"], ["TU8", "3"], ["TR11", "2"], ["TC20", "1"]]},
  {name: "mcu.program_boot_node", pads: [["TJ3", "2"], ["TU8", "27"], ["TD4", "2"]]},
  {name: "ledr.package.k", pads: [["TD4", "1"], ["TR12", "1"]]},
  {name: "phy.reset", pads: [["TU9", "37"]]},
  {name: "phy.spi.sck", pads: [["TU8", "9"], ["TU9", "33"]]},
  {name: "phy.spi.mosi", pads: [["TU8", "8"], ["TU9", "35"]]},
  {name: "phy.spi.miso", pads: [["TU8", "7"], ["TU9", "34"]]},
  {name: "phy.cs", pads: [["TU8", "35"], ["TU9", "32"]]},
  {name: "phy.int", pads: [["TU8", "31"], ["TU9", "36"], ["TU11", "5"]]},
  {name: "phy.ic.avdd", pads: [["TU9", "11"], ["TU9", "15"], ["TU9", "17"], ["TU9", "21"], ["TU9", "4"], ["TU9", "8"], ["TFB2", "2"], ["TC27", "1"], ["TC28", "1"], ["TC29", "1"], ["TC30", "1"], ["TC31", "1"], ["TC32", "1"], ["TC33", "1"], ["TR18", "1"], ["TR19", "1"], ["TR20", "1"]]},
  {name: "phy.ic.v1v20", pads: [["TU9", "22"], ["TC23", "1"]]},
  {name: "phy.ic.tocap", pads: [["TU9", "20"], ["TC24", "1"]]},
  {name: "phy.ic.exres1", pads: [["TU9", "10"], ["TR13", "2"]]},
  {name: "phy.ic.crystal.xtal_in", pads: [["TU9", "30"], ["TX1", "1"], ["TC21", "1"]]},
  {name: "phy.ic.crystal.xtal_out", pads: [["TU9", "31"], ["TX1", "3"], ["TC22", "1"]]},
  {name: "phy.ic.txp", pads: [["TU9", "2"], ["TR14", "1"]]},
  {name: "phy.ic.txn", pads: [["TU9", "1"], ["TR15", "1"]]},
  {name: "phy.ic.rxp", pads: [["TU9", "6"], ["TR16", "1"]]},
  {name: "phy.ic.rxn", pads: [["TU9", "5"], ["TR17", "1"]]},
  {name: "phy.rxp_damp.b", pads: [["TR16", "2"], ["TC35", "2"], ["TR21", "1"]]},
  {name: "phy.rxn_damp.b", pads: [["TR17", "2"], ["TC36", "2"], ["TR22", "1"]]},
  {name: "dist.ic.i2c_rst", pads: [["TU10", "A1"], ["TR27", "2"]]},
  {name: "dist.ic.int", pads: [["TU10", "A3"], ["TR28", "2"]]},
  {name: "dist.ic.lpn", pads: [["TU10", "A5"], ["TR25", "2"]]},
  {name: "dist.ic.rsvd6", pads: [["TU10", "C2"], ["TR26", "2"]]},
  {name: "pd.ic.vconn", pads: [["TU11", "12"], ["TU11", "13"]]},
  {name: "ioe.ic.nrst", pads: [["TU12", "4"], ["TJ4", "3"], ["TC43", "1"]]},
  {name: "ioe.ic.osc.xtal_in", pads: [["TU12", "5"]]},
  {name: "ioe.ic.osc.xtal_out", pads: [["TU12", "6"]]},
  {name: "ioe.ic.swio", pads: [["TU12", "18"], ["TJ4", "2"]]},
  {name: "poe_sense.output", pads: [["TU12", "14"], ["TR29", "2"], ["TR30", "1"]]},
  {name: "cam.dvp8.xclk", pads: [["TU8", "21"], ["TJ5", "13"]]},
  {name: "cam.dvp8.pclk", pads: [["TU8", "19"], ["TJ5", "17"], ["TC46", "1"]]},
  {name: "cam.dvp8.href", pads: [["TU8", "23"], ["TJ5", "9"]]},
  {name: "cam.dvp8.vsync", pads: [["TU8", "24"], ["TJ5", "7"]]},
  {name: "cam.dvp8.y0", pads: [["TU8", "18"], ["TJ5", "19"]]},
  {name: "cam.dvp8.y1", pads: [["TU8", "17"], ["TJ5", "21"]]},
  {name: "cam.dvp8.y2", pads: [["TU8", "12"], ["TJ5", "22"]]},
  {name: "cam.dvp8.y3", pads: [["TU8", "11"], ["TJ5", "20"]]},
  {name: "cam.dvp8.y4", pads: [["TU8", "10"], ["TJ5", "18"]]},
  {name: "cam.dvp8.y5", pads: [["TU8", "15"], ["TJ5", "16"]]},
  {name: "cam.dvp8.y6", pads: [["TU8", "20"], ["TJ5", "14"]]},
  {name: "cam.dvp8.y7", pads: [["TU8", "22"], ["TJ5", "12"]]},
  {name: "cam.reset", pads: [["TU8", "25"], ["TJ5", "6"], ["TC45", "1"], ["TU13", "24"]]},
  {name: "cam.device.y.0", pads: [["TJ5", "24"]]},
  {name: "cam.device.y.1", pads: [["TJ5", "23"]]},
  {name: "flir.shutdown", pads: [["TU8", "34"], ["TU13", "23"]]},
  {name: "flir.spi.sck", pads: [["TU8", "39"], ["TU13", "13"]]},
  {name: "flir.spi.mosi", pads: [["TU8", "5"], ["TU13", "11"]]},
  {name: "flir.spi.miso", pads: [["TU8", "4"], ["TU13", "12"]]},
  {name: "flir.cs", pads: [["TU8", "38"], ["TU13", "14"]]},
  {name: "flir.vsync", pads: [["TU8", "6"], ["TU13", "2"]]},
  {name: "flir.ic.master_clk", pads: [["TU13", "26"], ["TX2", "3"]]}
])

const limit0 = pt(-0.07874015748031496, -0.07874015748031496);
const limit1 = pt(4.341141732283465, 3.375590551181103);

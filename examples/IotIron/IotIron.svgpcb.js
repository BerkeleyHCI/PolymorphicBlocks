...
board.setNetlist([
  ...
  {name: "Ioled.c2_cap.neg", pads: [["IJ3", "3"], ["IC15", "2"]]},
  {name: "Ioled.iref_res.a", pads: [["IJ3", "26"], ["IR9", "1"]]},
  ...
  {name: "Iledr.res.a", pads: [["ID2", "1"], ["IR10", "1"]]},
  {name: "Iconv.sw.driver.ic.hb", pads: [["IU9", "2"], ["IC26", "1"]]},
  {name: "Iconv.sw.low_gate_res.a", pads: [["IU9", "8"], ["IR11", "1"]]},
  {name: "Iconv.sw.low_gate_res.b", pads: [["IQ1", "4"], ["IR11", "2"]]},
  {name: "Iconv.sw.high_gate_res.a", pads: [["IU9", "3"], ["IR12", "1"]]},
  {name: "Iconv.sw.high_gate_res.b", pads: [["IQ2", "4"], ["IR12", "2"]]},
  ...
  {name: "Ilow_rc.output", pads: [["IU9", "6"], ["IR14", "2"], ["IC27", "1"], ["ITP6", "1"]]},
  {name: "Ihigh_pull.io", pads: [["IU3", "5"], ["IR15", "2"], ["IR16", "1"]]},
  {name: "Ihigh_rc.output", pads: [["IU9", "5"], ["IR16", "2"], ["IC28", "1"], ["ITP7", "1"]]},

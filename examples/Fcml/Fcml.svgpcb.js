  {name: "usb_fpga_chain_0.d_P", pads: [["J2", "A6"], ["J2", "B6"], ["R21", "2"], ["R22", "1"], ["U13", "2"]]},
  {name: "usb_fpga_chain_0.d_N", pads: [["J2", "A7"], ["J2", "B7"], ["R23", "1"], ["U13", "1"]]},
  {name: "usb_mcu_chain_0.d_P", pads: [["J1", "A6"], ["J1", "B6"], ["R24", "1"], ["U16", "2"]]},
  {name: "usb_mcu_chain_0.d_N", pads: [["J1", "A7"], ["J1", "B7"], ["R25", "1"], ["U16", "1"]]},
  ...
  {name: "reg_vgate.ic.sw", pads: [["U2", "1"], ["L1", "2"], ["D2", "2"]]},
  {name: "reg_vgate.ic.fb", pads: [["U2", "3"], ["R5", "2"], ["R6", "1"]]},
  {name: "conv.pwr_out", pads: [["L2", "2"], ["C10", "1"], ["C11", "1"], ["C12", "1"], ["J4", "2"], ["TP5", "1"], ["R38", "1"]]},
  {name: "conv.pwms.0L", pads: [["U3", "3"], ["R30", "2"], ["C61", "1"]]},
  {name: "conv.pwms.0H", pads: [["U3", "2"], ["R31", "2"], ["C62", "1"]]},
  {name: "conv.pwms.1L", pads: [["U5", "3"], ["R32", "2"], ["C63", "1"]]},
  {name: "conv.pwms.1H", pads: [["U5", "2"], ["R33", "2"], ["C64", "1"]]},
  {name: "conv.pwms.2L", pads: [["U8", "3"], ["R34", "2"], ["C65", "1"]]},
  {name: "conv.pwms.2H", pads: [["U8", "2"], ["R35", "2"], ["C66", "1"]]},
  {name: "conv.power_path.switch", pads: [["L2", "1"], ["U9", "6"], ["C31", "2"], ["Q5", "1"], ["Q5", "2"], ["Q5", "3"], ["Q6", "5"], ["Q6", "6"], ["Q6", "7"], ["Q6", "8"], ["C34", "2"]]},
  {name: "conv.sw[0].low_out", pads: [["Q2", "5"], ["Q2", "6"], ["Q2", "7"], ["Q2", "8"], ["U4", "2"], ["C16", "2"], ["C17", "2"], ["U5", "5"], ["C19", "2"], ["U6", "4"], ["C20", "2"], ["C22", "2"], ["C23", "2"], ["Q4", "1"], ["Q4", "2"], ["Q4", "3"], ["C25", "2"]]},
  {name: "conv.sw[0].high_out", pads: [["U3", "6"], ["C14", "2"], ["Q1", "1"], ["Q1", "2"], ["Q1", "3"], ["C15", "2"], ["C22", "1"], ["C23", "1"], ["Q3", "5"], ["Q3", "6"], ["Q3", "7"], ["Q3", "8"]]},
  {name: "conv.sw[0].high_boot_in", pads: [["D3", "2"], ["U6", "8"], ["C21", "1"], ["C24", "1"], ["D5", "1"]]},
  {name: "conv.sw[0].driver.low_out", pads: [["U3", "5"], ["R8", "1"]]},
  {name: "conv.sw[0].driver.high_pwr", pads: [["U3", "8"], ["C14", "1"], ["C15", "1"], ["D3", "1"]]},
  {name: "conv.sw[0].driver.high_out", pads: [["U3", "7"], ["R7", "1"]]},
  {name: "conv.sw[0].high_gate_res.b", pads: [["R7", "2"], ["Q1", "4"]]},
  {name: "conv.sw[0].low_gate_res.b", pads: [["R8", "2"], ["Q2", "4"]]},
  {name: "conv.sw[1].low_out", pads: [["Q4", "5"], ["Q4", "6"], ["Q4", "7"], ["Q4", "8"], ["U7", "2"], ["C26", "2"], ["C27", "2"], ["U8", "5"], ["C29", "2"], ["U9", "4"], ["C30", "2"], ["C32", "2"], ["C33", "2"], ["Q6", "1"], ["Q6", "2"], ["Q6", "3"], ["C35", "2"]]},
  {name: "conv.sw[1].low_boot_out", pads: [["U4", "1"], ["U4", "3"], ["C16", "1"], ["U6", "1"], ["C20", "1"], ["D4", "1"], ["C25", "1"], ["D6", "2"]]},
  {name: "conv.sw[1].high_out", pads: [["U6", "6"], ["C21", "2"], ["Q3", "1"], ["Q3", "2"], ["Q3", "3"], ["C24", "2"], ["C32", "1"], ["C33", "1"], ["Q5", "5"], ["Q5", "6"], ["Q5", "7"], ["Q5", "8"]]},
  {name: "conv.sw[1].high_boot_in", pads: [["D5", "2"], ["U9", "8"], ["C31", "1"], ["C34", "1"], ["D7", "1"]]},
  {name: "conv.sw[1].ldo.pwr_out", pads: [["U4", "5"], ["C17", "1"], ["U5", "8"], ["C19", "1"]]},
  {name: "conv.sw[1].driver.low_in", pads: [["U5", "6"], ["U6", "3"]]},
  {name: "conv.sw[1].driver.high_in", pads: [["U5", "7"], ["U6", "2"]]},
  {name: "conv.sw[1].driver.low_out", pads: [["U6", "5"], ["R10", "1"]]},
  {name: "conv.sw[1].driver.high_out", pads: [["U6", "7"], ["R9", "1"]]},
  {name: "conv.sw[1].high_gate_res.b", pads: [["R9", "2"], ["Q3", "4"]]},
  {name: "conv.sw[1].low_gate_res.b", pads: [["R10", "2"], ["Q4", "4"]]},
  {name: "conv.sw[2].low_boot_out", pads: [["U7", "1"], ["U7", "3"], ["C26", "1"], ["U9", "1"], ["C30", "1"], ["D6", "1"], ["C35", "1"], ["D7", "2"]]},
  {name: "conv.sw[2].ldo.pwr_out", pads: [["U7", "5"], ["C27", "1"], ["U8", "8"], ["C29", "1"]]},
  {name: "conv.sw[2].driver.low_in", pads: [["U8", "6"], ["U9", "3"]]},
  {name: "conv.sw[2].driver.high_in", pads: [["U8", "7"], ["U9", "2"]]},
  {name: "conv.sw[2].driver.low_out", pads: [["U9", "5"], ["R12", "1"]]},
  {name: "conv.sw[2].driver.high_out", pads: [["U9", "7"], ["R11", "1"]]},
  ...
  {name: "fpga.ic.vcc", pads: [["U10", "30"], ["U10", "5"], ["U11", "5"], ["C37", "1"], ["R15", "1"], ["C43", "1"]]},
  {name: "fpga.ic.vcc_pll", pads: [["U10", "29"], ["R15", "2"], ["C44", "1"], ["C45", "1"]]},
  ...
  {name: "fpga.mem.cs", pads: [["U12", "1"], ["JP1", "2"], ["R14", "2"]]},
  {name: "cdone.package.k", pads: [["D8", "1"], ["R16", "1"]]},
  {name: "fpga_osc.out", pads: [["U10", "37"], ["X1", "3"]]},
  ...
  {name: "usb_fpga_bitbang.dp", pads: [["U10", "26"], ["R22", "2"]]},
  {name: "usb_fpga_bitbang.dm", pads: [["U10", "25"], ["R23", "2"]]},
  ...
  {name: "tp_fpga[0].io", pads: [["U10", "2"], ["U14", "14"], ["TP7", "1"]]},
  {name: "tp_fpga[1].io", pads: [["U10", "3"], ["U14", "13"], ["TP8", "1"]]},
  {name: "tp_fpga[2].io", pads: [["U10", "4"], ["U14", "12"], ["TP9", "1"]]},
  {name: "tp_fpga[3].io", pads: [["U10", "6"], ["U14", "11"], ["TP10", "1"]]},

...
board.setNetlist([
  ...
  {name: "conv.pwr_in", pads: [["J3", "2"], ["C5", "1"], ["C6", "1"], ["C7", "1"], ["C8", "1"], ["C9", "1"], ["Q1", "5"], ["Q1", "6"], ["Q1", "7"], ["Q1", "8"], ["R36", "1"]]},
  ...
  {name: "conv.sw[0].high_gate_res.a", pads: [["U3", "7"], ["R7", "1"]]},
  {name: "conv.sw[0].high_gate_res.b", pads: [["R7", "2"], ["Q1", "4"]]},
  {name: "conv.sw[0].low_gate_res.a", pads: [["U3", "5"], ["R8", "1"]]},
  {name: "conv.sw[0].low_gate_res.b", pads: [["R8", "2"], ["Q2", "4"]]},
  {name: "conv.sw[0].high_boot_cap.pos", pads: [["U3", "8"], ["C14", "1"], ["C15", "1"], ["D3", "1"]]},
  {name: "conv.sw[1].high_in", pads: [["U3", "6"], ["C14", "2"], ["Q1", "1"], ["Q1", "2"], ["Q1", "3"], ["C15", "2"], ["C22", "1"], ["C23", "1"], ["Q3", "5"], ["Q3", "6"], ["Q3", "7"], ["Q3", "8"]]},
  {name: "conv.sw[1].high_boot_out", pads: [["D3", "2"], ["U6", "8"], ["C21", "1"], ["C24", "1"], ["D5", "1"]]},
  {name: "conv.sw[1].low_out", pads: [["Q4", "5"], ["Q4", "6"], ["Q4", "7"], ["Q4", "8"], ["U7", "2"], ["C26", "2"], ["C27", "2"], ["U8", "5"], ["C29", "2"], ["U9", "4"], ["C30", "2"], ["C32", "2"], ["C33", "2"], ["Q6", "1"], ["Q6", "2"], ["Q6", "3"], ["C35", "2"]]},
  {name: "conv.sw[1].iso.pwr_b", pads: [["U4", "5"], ["C17", "1"], ["U5", "8"], ["C19", "1"]]},
  {name: "conv.sw[1].driver.high_in", pads: [["U5", "7"], ["U6", "2"]]},
  {name: "conv.sw[1].driver.low_in", pads: [["U5", "6"], ["U6", "3"]]},
  {name: "conv.sw[1].high_gate_res.a", pads: [["U6", "7"], ["R9", "1"]]},
  {name: "conv.sw[1].high_gate_res.b", pads: [["R9", "2"], ["Q3", "4"]]},
  {name: "conv.sw[1].low_gate_res.a", pads: [["U6", "5"], ["R10", "1"]]},
  {name: "conv.sw[1].low_gate_res.b", pads: [["R10", "2"], ["Q4", "4"]]},
  {name: "conv.sw[2].high_in", pads: [["U6", "6"], ["C21", "2"], ["Q3", "1"], ["Q3", "2"], ["Q3", "3"], ["C24", "2"], ["C32", "1"], ["C33", "1"], ["Q5", "5"], ["Q5", "6"], ["Q5", "7"], ["Q5", "8"]]},
  {name: "conv.sw[2].low_boot_in", pads: [["U4", "1"], ["U4", "3"], ["C16", "1"], ["U6", "1"], ["C20", "1"], ["D4", "1"], ["C25", "1"], ["D6", "2"]]},
  {name: "conv.sw[2].high_boot_out", pads: [["D5", "2"], ["U9", "8"], ["C31", "1"], ["C34", "1"], ["D7", "1"]]},
  {name: "conv.sw[2].low_boot_out", pads: [["U7", "1"], ["U7", "3"], ["C26", "1"], ["U9", "1"], ["C30", "1"], ["D6", "1"], ["C35", "1"], ["D7", "2"]]},
  {name: "conv.sw[2].iso.pwr_b", pads: [["U7", "5"], ["C27", "1"], ["U8", "8"], ["C29", "1"]]},
  {name: "conv.sw[2].driver.high_in", pads: [["U8", "7"], ["U9", "2"]]},
  {name: "conv.sw[2].driver.low_in", pads: [["U8", "6"], ["U9", "3"]]},
  {name: "conv.sw[2].high_gate_res.a", pads: [["U9", "7"], ["R11", "1"]]},
  {name: "conv.sw[2].high_gate_res.b", pads: [["R11", "2"], ["Q5", "4"]]},
  {name: "conv.sw[2].low_gate_res.a", pads: [["U9", "5"], ["R12", "1"]]},
  ...
  {name: "fpga.vcc_reg.pwr_out", pads: [["U10", "30"], ["U10", "5"], ["U11", "5"], ["C37", "1"], ["R15", "1"], ["C43", "1"]]},
  {name: "fpga.cs_jmp.output", pads: [["U12", "1"], ["JP1", "2"], ["R14", "2"]]},
  {name: "fpga.pll_res.pwr_out", pads: [["U10", "29"], ["R15", "2"], ["C44", "1"], ["C45", "1"]]},
  {name: "cdone.res.a", pads: [["D8", "1"], ["R16", "1"]]},
  {name: "fpga_osc.out", pads: [["U10", "37"], ["X1", "3"]]},
  {name: "fpga_sw.out", pads: [["U10", "32"], ["SW1", "1"]]},
  {name: "fpga_led.led[0].res.a", pads: [["D9", "1"], ["R17", "1"]]},
  {name: "fpga_led.led[1].res.a", pads: [["D10", "1"], ["R18", "1"]]},
  {name: "fpga_led.led[2].res.a", pads: [["D11", "1"], ["R19", "1"]]},
  {name: "fpga_led.led[3].res.a", pads: [["D12", "1"], ["R20", "1"]]},
  ...
  {name: "mcu.ic.vreg_vout", pads: [["U14", "23"], ["U14", "45"], ["U14", "50"], ["C56", "1"], ["C57", "1"], ["C58", "1"]]},
  {name: "mcu_sw.out", pads: [["U14", "29"], ["SW2", "1"]]},
  {name: "mcu_leds.led[0].res.a", pads: [["D13", "1"], ["R26", "1"]]},
  {name: "mcu_leds.led[1].res.a", pads: [["D14", "1"], ["R27", "1"]]},
  {name: "mcu_leds.led[2].res.a", pads: [["D15", "1"], ["R28", "1"]]},
  {name: "mcu_leds.led[3].res.a", pads: [["D16", "1"], ["R29", "1"]]},

...
class Opa189_Device(Opax189_Base_Device, JlcPart, FootprintBlock):
  ...
  def contents(self):
    ...
    self.footprint(
      ...
      mfr='Texas Instruments', part='OPA189DR',
...
class Opa189(Opamp):
  ...
  def contents(self):
    ...
    # Datasheet section 10: use a low-ESR 0.1uF capacitor between each supply and ground pin
...
class Opa2189(MultipackBlock, GeneratorBlock):

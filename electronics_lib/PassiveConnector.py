...
class Fpc050BottomFlip(Fpc050Bottom):
  ...
  def generate(self):
    # TODO: unlike other PassiveConnectors which are a footprint, this isn't and doesn't call super().generate()
    # TODO: refactor PassiveConnector (interface) from FootprintPassiveConnector (implementation)

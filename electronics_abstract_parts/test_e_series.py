...
class PreferredNumberTestCase(unittest.TestCase):
  ...
  def test_preferred_number(self) -> None:
    ...
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(0.09, 0.11), ESeriesUtil.E24_SERIES[24], 0.01),
                     0.1)
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(0.9, 1.1), ESeriesUtil.E24_SERIES[24], 0.01),
                     1)
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(9, 11), ESeriesUtil.E24_SERIES[24], 0.01),
                     10)
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(900, 1100), ESeriesUtil.E24_SERIES[24], 0.01),
                     1000)

    # Test a few different numbers
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(8100, 8300), ESeriesUtil.E24_SERIES[24], 0.01),
                     8200)
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(460, 480), ESeriesUtil.E24_SERIES[24], 0.01),
                     470)

    # Test preference for lower E-series first
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(101, 9999), ESeriesUtil.E24_SERIES[24], 0.01),
                     1000)
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(220, 820), ESeriesUtil.E24_SERIES[24], 0.01),
                     470)

    # Test dynamic range edge cases
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(999, 1500), ESeriesUtil.E24_SERIES[24], 0.01),
                     1200)
    self.assertEqual(ESeriesUtil.choose_preferred_number(Range(680, 1001), ESeriesUtil.E24_SERIES[24], 0.01),
                     820)

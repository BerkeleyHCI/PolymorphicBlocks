...
class HierarchyBlock(google.protobuf.message.Message):
    ...
    class variable2(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        def __init__(self,
            *,
            param: typing.Optional[edgir.ref_pb2.LocalPath] = ...,
            unit: typing.Text = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["param",b"param"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["param",b"param","unit",b"unit"]) -> None: ...
    ...
    class StringDescriptionElement(google.protobuf.message.Message):
        ...
        @property
        def var(self) -> global___HierarchyBlock.variable2: ...
        def __init__(self,
            *,
            text: typing.Text = ...,
            variable: typing.Text = ...,
            var: typing.Optional[global___HierarchyBlock.variable2] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["ElementType",b"ElementType","text",b"text","var",b"var","variable",b"variable"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["ElementType",b"ElementType","text",b"text","var",b"var","variable",b"variable"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["ElementType",b"ElementType"]) -> typing.Optional[typing_extensions.Literal["text","variable","var"]]: ...

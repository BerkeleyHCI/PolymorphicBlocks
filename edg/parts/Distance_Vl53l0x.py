...
class Vl53l0x(DistanceSensor, Resettable, GeneratorBlock):
    ...
    def __init__(self) -> None:
        ...
        self.int = self.Port(DigitalSource.empty(), optional=True, doc="Interrupt output for new data available")
...
class Vl53l0xConnector(Vl53l0x, WrapperSubboardBlock):
    ...
    def generate(self) -> None:
        ...
        self.export_tap(self.int.net, self.conn.pins.request("5"))
        self.export_tap(self.reset.net, self.conn.pins.request("6"))

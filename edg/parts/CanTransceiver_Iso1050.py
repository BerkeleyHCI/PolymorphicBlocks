...
class Iso1050dub_Device(InternalSubcircuit, FootprintBlock):
    def __init__(self) -> None:
        ...
        self.vcc1 = self.Port(VoltageSink(voltage_limits=(3, 5.5) * Volt, current_draw=(0, 3.6) * mAmp))
        self.vcc2 = self.Port(VoltageSink(voltage_limits=(4.75, 5.25) * Volt, current_draw=(0, 73) * mAmp))

    ...
    def _io_pinmap(self) -> PinMapUtil:
        ...
        return PinMapUtil(
            [  # Table 12, partial table for up to 32-pin only
                ...
                PeripheralFixedResource(
                    "I2C1", i2c_model, {"scl": ["PA9", "PB6", "PB8"], "sda": ["PA10", "PB7", "PB9"]}
                ),
                PeripheralFixedResource(
                    "I2C1_T",
                    i2c_target_model,
                ...
                PeripheralFixedResource("I2C2", i2c_model, {"scl": ["PA11"], "sda": ["PA12"]}),
                PeripheralFixedResource(
                    "I2C2_T",
                    i2c_target_model,
                    {"scl": ["PA11"], "sda": ["PA12"]},  # TODO shared resource w/ I2C controller
                ),
                PeripheralFixedResource(
                    "SWD",

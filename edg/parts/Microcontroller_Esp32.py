...
class Esp32_Ios(Esp32_Interfaces, BaseIoControllerPinmapGenerator):
    ...
    def _vdd_model(self) -> VoltageSink:
        return VoltageSink(
            ...
            current_draw=(0.001, 370) * mAmp
            + self.io_current_draw.upper(),  # from power off (table 8) to RF working (WRROM datasheet table 9)
        )
    ...
    def _io_pinmap(self) -> PinMapUtil:
        ...
        return PinMapUtil(
            [  # section 2.2, table 1
                ...
                PinResource(
                    "32K_XP", {"GPIO32": dio_model, "ADC1_CH4": adc_model, "TOUCH9": touch_model}
                ),  # also RTC_GPIO, 32K_XP
                PinResource(
                    "32K_XN", {"GPIO33": dio_model, "ADC1_CH5": adc_model, "TOUCH8": touch_model}
                ),  # also RTC_GPIO, 32K_XN
                PinResource(
                    "GPIO25", {"GPIO25": dio_model, "ADC2_CH8": adc_model, "DAC_1": dac_model}
                ),  # also RTC_GPIO
                PinResource(
                    "GPIO26", {"GPIO26": dio_model, "ADC2_CH9": adc_model, "DAC_2": dac_model}
                ),  # also RTC_GPIO
                PinResource(
                    "GPIO27", {"GPIO27": dio_model, "ADC2_CH7": adc_model, "TOUCH7": touch_model}
                ),  # also RTC_GPIO
                PinResource(
                    "MTMS", {"GPIO14": dio_model, "ADC2_CH6": adc_model, "TOUCH6": touch_model}
                ),  # also RTC_GPIO
                PinResource(
                    "MTDI", {"GPIO12": dio_model, "ADC2_CH5": adc_model, "TOUCH5": touch_model}
                ),  # also RTC_GPIO, noncritical strapping pin
                PinResource(
                    "MTCK", {"GPIO13": dio_model, "ADC2_CH4": adc_model, "TOUCH4": touch_model}
                ),  # also RTC_GPIO
                PinResource(
                    "MTDO", {"GPIO15": dio_model, "ADC2_CH3": adc_model, "TOUCH3": touch_model}
                ),  # also RTC_GPIO, noncritical strapping pin
                ...
                PinResource(
                    "GPIO4", {"GPIO4": dio_model, "ADC2_CH0": adc_model, "TOUCH0": touch_model}
                ),  # also RTC_GPIO
                # VDD_SDIO
...
class Esp32_Base(Esp32_Ios, GeneratorBlock):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.io2 = self.Port(
            dio_model, optional=True
        )  # default pulldown (enable download boot), ignored during SPI boot
...
class Freenove_Esp32_Wrover(
    IoControllerUsbOut, IoControllerPowerOut, Esp32_Ios, IoController, GeneratorBlock, FootprintBlock
):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.io2 = self.Port(
            DigitalBidir.empty(), optional=True
        )  # default pulldown (enable download boot), ignored during SPI boot

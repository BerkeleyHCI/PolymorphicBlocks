...
class JlcCapacitor(JlcTableSelector, PartsTableSelectorFootprint, TableDeratingCapacitor, CeramicCapacitor):
    ...
    def _make_table(cls) -> PartsTable:
        ...
        def parse_row(row: PartsTableRow) -> Optional[Dict[PartsTableColumn, Any]]:
            ...
            try:
                ...
                new_cols[cls.CAPACITANCE] = PartParserUtil.parse_abs_tolerance(
                    extracted_values["tolerance"][1], nominal_capacitance, "F"
                )
                new_cols[cls.NOMINAL_CAPACITANCE] = nominal_capacitance

                new_cols[cls.VOLTAGE_RATING] = (
                    Range.from_abs_tolerance(  # voltage rating for ceramic caps is bidirectional
    ...
    def _make_parallel_footprints(self, row: PartsTableRow) -> None:
        cap_model = JlcDummyCapacitor(
            set_lcsc_part=row[self.LCSC_PART_HEADER],
...
class JlcDummyCapacitor(JlcPart, DummyCapacitorFootprint):
    ...
    def __init__(
        self,
        set_lcsc_part: StringLike = "",
        set_basic_part: BoolLike = False,
        ...
        **kwargs: Any,
        ...
        super().__init__(
            footprint=footprint, manufacturer=manufacturer, part_number=part_number, value=value, *args, **kwargs
        )

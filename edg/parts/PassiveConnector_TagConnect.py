...
class TagConnectLegged(TagConnect):
    ...
    def part_footprint_mfr_name(self, length: int) -> Tuple[str, str, str]:
        return (
            f"Connector:Tag-Connect_TC20{length // 2}0-IDC-FP_2x{length // 2:02d}_P1.27mm_Vertical",
            "",
            "",
        )  # no physical part
...
class TagConnectNonLegged(TagConnect):
    ...
    def part_footprint_mfr_name(self, length: int) -> Tuple[str, str, str]:
        return (
            f"Connector:Tag-Connect_TC20{length // 2}0-IDC-NL_2x{length // 2:02d}_P1.27mm_Vertical",
            "",
            "",
        )  # no physical part

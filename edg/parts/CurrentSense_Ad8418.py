...
class Ad8418a_Device(JlcPart, FootprintBlock, InternalSubcircuit):
    ...
    def __init__(self, in_diff_range: RangeLike):
        ...
        self.vs = self.Port(
            VoltageSink(voltage_limits=(2.7, 5.5) * Volt, current_draw=(4.1, 4.2) * mAmp)  # maximum only
        )
...
class Ad8418a(CurrentSensor, KiCadImportableBlock, Block):
    ...
    def symbol_pinning(self, symbol_name: str) -> Dict[str, BasePort]:
        ...
        return {"+": self.sense_pos, "-": self.sense_neg, "R": self.ref, "3": self.out, "V+": self.pwr, "V-": self.gnd}

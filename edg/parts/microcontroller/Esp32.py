...
class Esp32_Wroom_32_Device(
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self._dio_model = DigitalBidir.from_supply(  # section 5.2, table 15
            self.gnd,
            self.pwr,
    ...
    def _io_pinmap(self) -> PinMapUtil:
        ...
        i2c_model = I2cController(DigitalBidir.empty(), frequency_limit=(0, 5) * MHertz)  # section 4.1.11
        i2c_target_model = I2cTarget(DigitalBidir.empty(), frequency_limit=(0, 5) * MHertz)
...
class Freenove_Esp32_Wrover_Device(Esp32_Interfaces, BaseIoControllerWrapped, GeneratorBlock, FootprintBlock):
    _PIN_REMAPPING = {
            ...
            self._make_pinning(
                {
                    ...
                    "19": self.vcc,  # Vcc 5vUSB, input to internal LDO
                    "20": self.vcc,
                    "14": self.gnd,
                    "21": self.gnd,
                    "29": self.gnd,

...
class Pcf2129_Device(InternalSubcircuit, FootprintBlock):
    ...
    def __init__(self) -> None:
        ...
        self.pwr = self.Port(VoltageSink(voltage_limits=(1.8, 4.2) * Volt, current_draw=(0, 800) * uAmp), [Power])
        self.pwr_bat = self.Port(VoltageSink(voltage_limits=(1.8, 4.2) * Volt, current_draw=(0, 100) * nAmp))

...
class EInkBoostPowerPath(Interface, KiCadSchematicBlock):
    ...
    def contents(self) -> None:
        ...
        self.inductor = self.Block(Inductor(inductance=self.inductance, current=self.current))
        self.sense = self.Block(Resistor(resistance=self.resistance))

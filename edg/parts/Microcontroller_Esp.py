...
class EspProgrammingAutoReset(BlockInterfaceMixin[EspProgrammingHeader]):
    ...
    def contents(self) -> None:
        super().contents()
        self.require(
            self.require_auto_reset.implies(self.en.is_connected() & self.boot.is_connected()),
...
class EspAutoProgram(Interface, KiCadSchematicBlock):
    ...
    def contents(self) -> None:
        ...
        self.import_kicad(
            ...
            conversions={"dtr": DigitalSink(), "rts": DigitalSink(), "en": output_model, "boot": output_model},
        )

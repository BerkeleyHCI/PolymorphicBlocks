...
class Lm2664_Device(InternalSubcircuit, JlcPart, FootprintBlock):
    ...
    def __init__(self) -> None:
        ...
        self.vp = self.Port(VoltageSink(voltage_limits=(1.8, 5.5) * Volt, current_draw=RangeExpr()), [Power])
...
class Lm2664(PowerConditioner, Block):
    ...
    def __init__(self, output_resistance_limit: FloatLike = 25 * Ohm, output_ripple_limit: FloatLike = 25 * mVolt):
        super().__init__()

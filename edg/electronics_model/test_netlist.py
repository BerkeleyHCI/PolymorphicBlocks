        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("pos", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos", "net"),
                    TransformUtil.Path.empty().append_block("sink", "block").append_port("pos", "net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("neg", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg", "net"),
                    TransformUtil.Path.empty().append_block("sink", "block").append_port("neg", "net"),
                ],
            ),
            net.nets,
        )
        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("pos", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos", "net"),
                    TransformUtil.Path.empty().append_block("sink", "block1").append_port("pos", "net"),
                    TransformUtil.Path.empty().append_block("sink", "block2").append_port("pos", "net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("neg", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg", "net"),
                    TransformUtil.Path.empty().append_block("sink", "block1").append_port("neg", "net"),
                    TransformUtil.Path.empty().append_block("sink", "block2").append_port("neg", "net"),
                ],
            ),
            net.nets,
        )

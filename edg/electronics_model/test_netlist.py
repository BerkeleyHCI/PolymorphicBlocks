...
class TestFakeSource(FootprintBlock):
    ...
    def contents(self) -> None:
        ...
        self.footprint(  # beefy (ok, not really) capacitor
            "C", "Capacitor_SMD:C_0603_1608Metric", {"1": self.pos, "2": self.neg}, value="1uF"
        )
...
class TestFakeSink(TestBaseFakeSink, FootprintBlock):
    ...
    def contents(self) -> None:
        ...
        self.footprint(  # load resistor
            "R", "Resistor_SMD:R_0603_1608Metric", {"1": self.pos, "2": self.neg}, value="1k"
        )
    ...
    def test_multisink_netlist(self) -> None:
        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink1").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink2").append_port("pos").append_port("net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink1").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink2").append_port("neg").append_port("net"),
                ],
            ),
            net.nets,
        )
    ...
    def test_multinet_netlist(self) -> None:
        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("adapter").append_port("pos_in").append_port("net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("adapter").append_port("pos_out").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos").append_port("net"),
                ],
            ),
            net.nets,
        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("adapter").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg").append_port("net"),
                ],
            ),
            net.nets,
        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink", "block").append_port("pos").append_port("net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink", "block").append_port("neg").append_port("net"),
                ],
            ),
            net.nets,
        )
        ...
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink", "block1").append_port("pos").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink", "block2").append_port("pos").append_port("net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    TransformUtil.Path.empty().append_block("source").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink", "block1").append_port("neg").append_port("net"),
                    TransformUtil.Path.empty().append_block("sink", "block2").append_port("neg").append_port("net"),
                ],
            ),
            net.nets,
        )

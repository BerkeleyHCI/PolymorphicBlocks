...
class AnalogLink(CircuitLink):
    ...
    def contents(self) -> None:
        ...
        self.description = DescriptionString(
            ...
            "\n<b>sink impedance</b>: ",
            DescriptionString.FormatUnits(self.sink_impedance, "Ω"),
            ", <b>source impedance</b>: ",
            DescriptionString.FormatUnits(self.source_impedance, "Ω"),
        )
...
class AnalogSinkBridge(CircuitPortBridge):
    def __init__(self) -> None:
        ...
        self.outer_port = self.Port(
            AnalogSink(
                current_draw=RangeExpr(), voltage_limits=RangeExpr(), signal_limits=RangeExpr(), impedance=RangeExpr()
            )
        )
    ...
    def from_supply(
        ...
        *,
        ...
        if signal_limit_abs is not None:
            ...
            signal_limit = (supply_range.lower() + signal_limit_bound[0], supply_range.upper() + signal_limit_bound[1])

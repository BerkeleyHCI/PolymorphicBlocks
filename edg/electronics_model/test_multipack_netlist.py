        ...
        self.assertIn(
            Net(
                ...
                [
                    ...
                    TransformUtil.Path.empty().append_block("sink2").append_port("pos", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos", "1", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("pos", "2", "net"),
                    TransformUtil.Path.empty().append_block("sink", "pos_comb").append_port("pwr_ins", "1", "net"),
                    TransformUtil.Path.empty().append_block("sink", "pos_comb").append_port("pwr_ins", "2", "net"),
                    TransformUtil.Path.empty().append_block("sink", "pos_comb", "packed").append_port("elts", "1"),
                    TransformUtil.Path.empty().append_block("sink", "pos_comb", "packed").append_port("elts", "2"),
                    TransformUtil.Path.empty().append_block("sink", "pos_comb", "packed").append_port("merged"),
                    TransformUtil.Path.empty().append_block("sink", "pos_comb").append_port("pwr_out", "net"),
                    TransformUtil.Path.empty().append_block("sink", "device").append_port("pos", "net"),
                ],
            ),
            net.nets,
        )
        self.assertIn(
            Net(
                ...
                [
                    ...
                    TransformUtil.Path.empty().append_block("sink2").append_port("neg", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg", "1", "net"),
                    TransformUtil.Path.empty().append_block("sink").append_port("neg", "2", "net"),
                    TransformUtil.Path.empty().append_block("sink", "neg_comb").append_port("pwr_ins", "1", "net"),
                    TransformUtil.Path.empty().append_block("sink", "neg_comb").append_port("pwr_ins", "2", "net"),
                    TransformUtil.Path.empty().append_block("sink", "neg_comb", "packed").append_port("elts", "1"),
                    TransformUtil.Path.empty().append_block("sink", "neg_comb", "packed").append_port("elts", "2"),
                    TransformUtil.Path.empty().append_block("sink", "neg_comb", "packed").append_port("merged"),
                    TransformUtil.Path.empty().append_block("sink", "neg_comb").append_port("pwr_out", "net"),
                    TransformUtil.Path.empty().append_block("sink", "device").append_port("neg", "net"),
                ],
            ),
            net.nets,
        )

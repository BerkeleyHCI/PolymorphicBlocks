...
class KiCadBlackboxBlockAutoadapt(KiCadSchematicBlock):
    ...
    def __init__(self) -> None:
        ...
        self.import_kicad(self.file_path("resources", "test_kicad_import_blackbox.kicad_sch"), auto_adapt=True)
...
class KiCadImportBlackboxTestCase(unittest.TestCase):
    def test_import_blackbox(self) -> None:
        ...
        self.assertIn(
            edgir.AssignLit(["U1", "kicad_datasheet"], "http://ww1.microchip.com/downloads/en/DeviceDoc/21942e.pdf"),
            constraints,
        )

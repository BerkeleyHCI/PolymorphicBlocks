...
class PartPlacerTestCase(unittest.TestCase):
    ...
    def test_placement_hierarchical(self):
        ...
        self.assertEqual(arranged.elts[0][0].elts[0][0], TransformUtil.Path.empty().append_block("A").append_block("U1"))
        ...
        self.assertEqual(arranged.elts[0][0].elts[1][0], TransformUtil.Path.empty().append_block("A").append_block("R1"))
        ...
        self.assertEqual(arranged.elts[0][0].elts[2][0], TransformUtil.Path.empty().append_block("A").append_block("R2"))
        ...
        self.assertEqual(arranged.elts[1][0].elts[0][0], TransformUtil.Path.empty().append_block("B").append_block("R3"))
    ...
    def test_placement_bbox(self):
        ...
        arranged = arrange_blocks([r1, r2],
                                  [BlackBoxBlock(TransformUtil.Path.empty().append_block("box"), (-5, -5, 5, 5))])

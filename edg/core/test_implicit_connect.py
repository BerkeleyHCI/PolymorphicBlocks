...
class ImplicitConnectBlock(Block):
    ...
    def contents(self) -> None:
        ...
        with self.implicit_connect(ImplicitConnect(self.block_source.source, [ImplicitSink])) as imp:
...
class ExportedImplicitConnectBlock(Block):
    ...
    def contents(self) -> None:
        ...
        with self.implicit_connect(ImplicitConnect(self.sink_in, [ImplicitSink])) as imp:

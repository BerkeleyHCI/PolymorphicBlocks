...
class PathTestCase(unittest.TestCase):
    def test_startswith(self) -> None:
        ...
        self.assertTrue(
            path.append_block("a").append_link("b", "c").startswith(path.append_block("a").append_link("b"))
        )
        self.assertTrue(
            path.append_block("a").append_link("b", "c").startswith(path.append_block("a").append_link("b", "c"))
        )

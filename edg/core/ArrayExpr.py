...
class ArrayExpr(
    ConstraintExpr[ArrayWrappedType, ArrayCastableType], Generic[ArrayEltType, ArrayWrappedType, ArrayCastableType]
):
...
class ArrayRangeExpr(ArrayExpr[RangeExpr, List[Range], ArrayRangeLike]):
    ...
    def _create_binary_set_op(self, lhs: ConstraintExpr, rhs: ConstraintExpr, op: NumericOp) -> ArrayRangeExpr:

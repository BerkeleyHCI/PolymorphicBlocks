...
class CompilerResult(_message.Message):
    ...
    def __init__(self, *, design: _schema_pb2.Design | None=..., errors: _abc.Iterable[Global___ErrorRecord] | None=..., solvedValues: _abc.Iterable[Global___CompilerResult.Value] | None=...) -> None:
        ...
    _HasFieldArgType: _TypeAlias = _typing.Literal['design', b'design']

    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool:
        ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal['design', b'design', 'errors', b'errors', 'solvedValues', b'solvedValues']

...
class OpampCurrentSensor(CurrentSensor, KiCadImportableBlock, Block):
    ...
    def __init__(self, resistance: RangeLike, ratio: RangeLike, input_impedance: RangeLike):
        ...
        self.amp = self.Block(DifferentialAmplifier(ratio=ratio, input_impedance=input_impedance))
    ...
    def symbol_pinning(self, symbol_name: str) -> Dict[str, Port]:
        ...
        return {"+": self.pwr_in, "-": self.pwr_out, "R": self.ref, "3": self.out, "V+": self.pwr, "V-": self.gnd}

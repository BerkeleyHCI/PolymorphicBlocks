...
class FerriteBead(PassiveComponent, KiCadImportableBlock, HasStandardFootprint):
    ...
    def __init__(
        ...
        *,
        ...
        dc_resistance: RangeLike = RangeExpr.ALL,
    ) -> None:
        super().__init__()
    ...
    def contents(self) -> None:
        ...
        self.description = DescriptionString(
            ...
            "\n",
            "<b>HF impedance:</b> ",
            DescriptionString.FormatUnits(self.actual_hf_impedance, "Ω"),
            " <b>of spec:</b> ",
            DescriptionString.FormatUnits(self.hf_impedance, "Ω"),
            "\n",
            "<b>DC resistance:</b> ",
            DescriptionString.FormatUnits(self.actual_dc_resistance, "Ω"),
            " <b>of spec:</b> ",
            DescriptionString.FormatUnits(self.dc_resistance, "Ω"),
        )
...
class TableFerriteBead(PartsTableSelector, FerriteBead):
    ...
    def _row_filter(self, row: PartsTableRow) -> bool:
        return (
            ...
            and row[self.HF_IMPEDANCE].fuzzy_in(self.get(self.hf_impedance))
            and row[self.DC_RESISTANCE].fuzzy_in(self.get(self.dc_resistance))
        )

...
class MultipackOpampGenerator(MultipackOpamp, GeneratorBlock):
    ...
    def __init__(self) -> None:
        ...
        self.generator_param(
            self.pwr.requested(), self.gnd.requested(), self.inn.requested(), self.inp.requested(), self.out.requested()
        )
    ...
    def generate(self) -> None:
        ...
        assert (
            self.get(self.gnd.requested())
            == self.get(self.inp.requested())
            == self.get(self.inn.requested())
            == self.get(self.out.requested())
            == requested
        )

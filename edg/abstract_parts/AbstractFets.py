...
class Fet(KiCadImportableBlock, DiscreteSemiconductor, HasStandardFootprint):
    ...
    def __init__(
        ...
        *,
        ...
        gate_charge: RangeLike = Range.all(),
    ...
    def contents(self) -> None:
        ...
        self.description = DescriptionString(
            "<b>Vds:</b> ",
            DescriptionString.FormatUnits(self.actual_drain_voltage_rating, "V"),
            " <b>of operating:</b> ",
            DescriptionString.FormatUnits(self.drain_voltage, "V"),
            "\n",
            "<b>Ids:</b> ",
            DescriptionString.FormatUnits(self.actual_drain_current_rating, "A"),
            " <b>of operating:</b> ",
            DescriptionString.FormatUnits(self.drain_current, "A"),
            "\n",
            "<b>Vgs,max:</b> ",
            DescriptionString.FormatUnits(self.actual_gate_voltage_rating, "V"),
            " <b>of operating:</b> ",
            DescriptionString.FormatUnits(self.gate_voltage, "V"),
            "\n",
            "<b>Vgs,th:</b> ",
            DescriptionString.FormatUnits(self.actual_gate_drive, "V"),
            "\n",
            "<b>Rds,on:</b> ",
            DescriptionString.FormatUnits(self.actual_rds_on, "Ω"),
            " <b>of spec:</b> ",
            DescriptionString.FormatUnits(self.rds_on, "Ω"),
            "\n" "<b>Pmax:</b> ",
...
class TableFet(PartsTableSelector, BaseTableFet):
    ...
    def _row_filter(self, row: PartsTableRow) -> bool:
        return (
            ...
            and row[self.RDS_ON].fuzzy_in(self.get(self.rds_on))
            and row[self.GATE_CHARGE].fuzzy_in(self.get(self.gate_charge))
...
class SwitchFet(Fet):
    ...
    def __init__(
        self, *, frequency: RangeLike = 0 * Hertz(tol=0), drive_current: RangeLike = Range.all(), **kwargs: Any
    ) -> None:
...
class TableSwitchFet(PartsTableSelector, SwitchFet, BaseTableFet):
    ...
    def _table_postprocess(self, table: PartsTable) -> PartsTable:
        ...
        assert (
            gate_drive_rise > 0 and gate_drive_fall > 0

...
class GeneratorRequest(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"element",b"element"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"element",b"element",u"modules",b"modules",u"values",b"values"]) -> None: ...
type___GeneratorRequest = GeneratorRequest

class SolvedConstraints(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    class Value(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    ...
    @property
    def values(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___SolvedConstraints.Value]: ...

    def __init__(self,
        *,
        values : typing___Optional[typing___Iterable[type___SolvedConstraints.Value]] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"values",b"values"]) -> None: ...
type___SolvedConstraints = SolvedConstraints

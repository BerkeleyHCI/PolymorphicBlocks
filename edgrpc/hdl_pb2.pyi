...
class LibraryRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"element",b"element"]) -> None: ...
...
class GeneratorRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"element",b"element"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"element",b"element",u"fn",b"fn",u"values",b"values"]) -> None: ...
...
class Refinements(google.protobuf.message.Message):
    ...
    class Subclass(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"cls",b"cls",u"path",b"path",u"replacement",b"replacement",u"source",b"source"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"cls",b"cls",u"path",b"path",u"replacement",b"replacement",u"source",b"source"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"source",b"source"]) -> typing.Optional[typing_extensions.Literal["path","cls"]]: ...
    ...
    class Value(google.protobuf.message.Message):
        ...
        class ClassParamPath(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal[u"cls",b"cls",u"param_path",b"param_path"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal[u"cls",b"cls",u"param_path",b"param_path"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"cls_param",b"cls_param",u"path",b"path",u"source",b"source",u"value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"cls_param",b"cls_param",u"path",b"path",u"source",b"source",u"value",b"value"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"source",b"source"]) -> typing.Optional[typing_extensions.Literal["path","cls_param"]]: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"subclasses",b"subclasses",u"values",b"values"]) -> None: ...
...
class IndexResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"indexed",b"indexed"]) -> None: ...
...
class LibraryResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"element",b"element",u"error",b"error",u"refinements",b"refinements",u"result",b"result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"element",b"element",u"error",b"error",u"refinements",b"refinements",u"result",b"result"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"result",b"result"]) -> typing.Optional[typing_extensions.Literal["element","error"]]: ...
...
class GeneratorResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"error",b"error",u"generated",b"generated",u"result",b"result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"error",b"error",u"generated",b"generated",u"result",b"result"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"result",b"result"]) -> typing.Optional[typing_extensions.Literal["generated","error"]]: ...
...
class HdlRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"elaborate_generator",b"elaborate_generator",u"get_library_element",b"get_library_element",u"index_module",b"index_module",u"request",b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"elaborate_generator",b"elaborate_generator",u"get_library_element",b"get_library_element",u"index_module",b"index_module",u"request",b"request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"request",b"request"]) -> typing.Optional[typing_extensions.Literal["index_module","get_library_element","elaborate_generator"]]: ...
...
class HdlResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"elaborate_generator",b"elaborate_generator",u"get_library_element",b"get_library_element",u"index_module",b"index_module",u"response",b"response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"elaborate_generator",b"elaborate_generator",u"get_library_element",b"get_library_element",u"index_module",b"index_module",u"response",b"response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"response",b"response"]) -> typing.Optional[typing_extensions.Literal["index_module","get_library_element","elaborate_generator"]]: ...
